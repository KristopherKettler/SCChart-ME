package info.scce.cinco.product.scchart;
...
public class SCChartToolProjectWizard extends Wizard implements IWorkbenchWizard {
	...
	public boolean performFinish() {
		...
		try {
			workbench.showPerspective("info.scce.cinco.product.scchart.sccharttoolperspective", workbench.getActiveWorkbenchWindow());
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		setWindowTitle("New SCChartTool Project");
	}
	...
	private class CreateNewProjectPage extends WizardPage {
		...
		protected CreateNewProjectPage(String pageName) {
			super(pageName);
			setTitle("New SCChartTool Project");
			setDescription("Initialize an empty SCChartTool project and switch to correct perspective");
