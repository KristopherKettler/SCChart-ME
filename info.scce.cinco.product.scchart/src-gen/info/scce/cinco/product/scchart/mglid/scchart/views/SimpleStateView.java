 ...
 * </p>
 * <ul>
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.views.SimpleStateView#getInternalSimpleState <em>Internal Simple State</em>}</li>
 * </ul>
 *
 * @see info.scce.cinco.product.scchart.mglid.scchart.views.ViewsPackage#getSimpleStateView()
 * @model
 * @generated
 */
public interface SimpleStateView extends EObject {
	 ...
	 * @see info.scce.cinco.product.scchart.mglid.scchart.views.ViewsPackage#getSimpleStateView_InternalSimpleState()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link info.scce.cinco.product.scchart.mglid.scchart.views.SimpleStateView#getInternalSimpleState <em>Internal Simple State</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
