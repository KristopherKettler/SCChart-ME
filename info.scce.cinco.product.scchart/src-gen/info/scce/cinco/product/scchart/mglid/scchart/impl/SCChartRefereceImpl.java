...
public class SCChartRefereceImpl extends ModelElementContainerImpl implements SCChartReferece {
	...
	public boolean canMoveTo(final DataFlowRegion dataFlowRegion, final int x, final int y) {
		return dataFlowRegion.canContain(info.scce.cinco.product.scchart.mglid.scchart.SCChartReferece.class);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ScchartPackage.SC_CHART_REFERECE___SET_INPUTS_OUTPUTS__ELIST:
				setInputsOutputs((EList<String>)arguments.get(0));
				return null;
			case ScchartPackage.SC_CHART_REFERECE___ADD_INPUTS_OUTPUTS__STRING:
				addInputsOutputs((String)arguments.get(0));
				return null;
			case ScchartPackage.SC_CHART_REFERECE___REMOVE_INPUTS_OUTPUTS__STRING:
