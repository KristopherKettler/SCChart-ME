...
public class InternalInitilalSuperStateImpl extends InternalSuperStateImpl implements InternalInitilalSuperState {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == InternalSuperState.class) {
			switch (baseOperationID) {
				...
				case InternalPackage.INTERNAL_SUPER_STATE___GET_FINAL_SUPER_STATE_PREDECESSORS: return InternalPackage.INTERNAL_INITILAL_SUPER_STATE___GET_FINAL_SUPER_STATE_PREDECESSORS;
				...
				case InternalPackage.INTERNAL_SUPER_STATE___GET_SC_CHART_REFERECE_PREDECESSORS: return InternalPackage.INTERNAL_INITILAL_SUPER_STATE___GET_SC_CHART_REFERECE_PREDECESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_INITIAL_SC_CHART_REFERECE_PREDECESSORS: return InternalPackage.INTERNAL_INITILAL_SUPER_STATE___GET_INITIAL_SC_CHART_REFERECE_PREDECESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_FINAL_SC_CHART_REFERECE_PREDECESSORS: return InternalPackage.INTERNAL_INITILAL_SUPER_STATE___GET_FINAL_SC_CHART_REFERECE_PREDECESSORS;
				...
				case InternalPackage.INTERNAL_SUPER_STATE___GET_FINAL_SUPER_STATE_SUCCESSORS: return InternalPackage.INTERNAL_INITILAL_SUPER_STATE___GET_FINAL_SUPER_STATE_SUCCESSORS;
				...
				case InternalPackage.INTERNAL_SUPER_STATE___GET_SC_CHART_REFERECE_SUCCESSORS: return InternalPackage.INTERNAL_INITILAL_SUPER_STATE___GET_SC_CHART_REFERECE_SUCCESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_INITIAL_SC_CHART_REFERECE_SUCCESSORS: return InternalPackage.INTERNAL_INITILAL_SUPER_STATE___GET_INITIAL_SC_CHART_REFERECE_SUCCESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_FINAL_SC_CHART_REFERECE_SUCCESSORS: return InternalPackage.INTERNAL_INITILAL_SUPER_STATE___GET_FINAL_SC_CHART_REFERECE_SUCCESSORS;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case InternalPackage.INTERNAL_INITILAL_SUPER_STATE___GET_FINAL_SUPER_STATE_PREDECESSORS:
			...
			case InternalPackage.INTERNAL_INITILAL_SUPER_STATE___GET_SC_CHART_REFERECE_PREDECESSORS:
				return getSCChartReferecePredecessors();
			case InternalPackage.INTERNAL_INITILAL_SUPER_STATE___GET_INITIAL_SC_CHART_REFERECE_PREDECESSORS:
				return getInitialSCChartReferecePredecessors();
			case InternalPackage.INTERNAL_INITILAL_SUPER_STATE___GET_FINAL_SC_CHART_REFERECE_PREDECESSORS:
			...
			case InternalPackage.INTERNAL_INITILAL_SUPER_STATE___GET_FINAL_SUPER_STATE_SUCCESSORS:
			...
			case InternalPackage.INTERNAL_INITILAL_SUPER_STATE___GET_SC_CHART_REFERECE_SUCCESSORS:
				return getSCChartRefereceSuccessors();
			case InternalPackage.INTERNAL_INITILAL_SUPER_STATE___GET_INITIAL_SC_CHART_REFERECE_SUCCESSORS:
				return getInitialSCChartRefereceSuccessors();
			case InternalPackage.INTERNAL_INITILAL_SUPER_STATE___GET_FINAL_SC_CHART_REFERECE_SUCCESSORS:
