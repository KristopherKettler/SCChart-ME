 ...
 * @generated
 */
public class StrongAbortTransitionImpl extends TransitionImpl implements StrongAbortTransition {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == Transition.class) {
			switch (baseOperationID) {
				case ScchartPackage.TRANSITION___PRE_DELETE: return ScchartPackage.STRONG_ABORT_TRANSITION___PRE_DELETE;
				case ScchartPackage.TRANSITION___GET_POST_DELETE_FUNCTION: return ScchartPackage.STRONG_ABORT_TRANSITION___GET_POST_DELETE_FUNCTION;
				case ScchartPackage.TRANSITION___GET_POST_DELETE_EVENT: return ScchartPackage.STRONG_ABORT_TRANSITION___GET_POST_DELETE_EVENT;
				case ScchartPackage.TRANSITION___PRE_SAVE: return ScchartPackage.STRONG_ABORT_TRANSITION___PRE_SAVE;
				case ScchartPackage.TRANSITION___POST_SAVE: return ScchartPackage.STRONG_ABORT_TRANSITION___POST_SAVE;
				case ScchartPackage.TRANSITION___GET_ROOT_ELEMENT: return ScchartPackage.STRONG_ABORT_TRANSITION___GET_ROOT_ELEMENT;
				case ScchartPackage.TRANSITION___GET_SOURCE_ELEMENT: return ScchartPackage.STRONG_ABORT_TRANSITION___GET_SOURCE_ELEMENT;
				case ScchartPackage.TRANSITION___GET_TARGET_ELEMENT: return ScchartPackage.STRONG_ABORT_TRANSITION___GET_TARGET_ELEMENT;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_SOURCE__INITILALSUBSUPERSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_SOURCE__INITILALSUBSUPERSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_SOURCE__INITILALSUBSUPERSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_SOURCE__INITILALSUBSUPERSTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_SOURCE__INITIALSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_SOURCE__INITIALSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_SOURCE__INITIALSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_SOURCE__INITIALSTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_SOURCE__CONNECTOR: return ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_SOURCE__CONNECTOR;
				case ScchartPackage.TRANSITION___RECONNECT_SOURCE__CONNECTOR: return ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_SOURCE__CONNECTOR;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_SOURCE__SUBSUPERSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_SOURCE__SUBSUPERSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_SOURCE__SUBSUPERSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_SOURCE__SUBSUPERSTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_SOURCE__SIMPLESTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_SOURCE__SIMPLESTATE;
				case ScchartPackage.TRANSITION___RECONNECT_SOURCE__SIMPLESTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_SOURCE__SIMPLESTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_SOURCE__ROOTSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_SOURCE__ROOTSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_SOURCE__ROOTSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_SOURCE__ROOTSTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_SOURCE__FINALSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_SOURCE__FINALSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_SOURCE__FINALSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_SOURCE__FINALSTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_TARGET__INITILALSUBSUPERSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_TARGET__INITILALSUBSUPERSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_TARGET__INITILALSUBSUPERSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_TARGET__INITILALSUBSUPERSTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_TARGET__INITIALSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_TARGET__INITIALSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_TARGET__INITIALSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_TARGET__INITIALSTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_TARGET__CONNECTOR: return ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_TARGET__CONNECTOR;
				case ScchartPackage.TRANSITION___RECONNECT_TARGET__CONNECTOR: return ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_TARGET__CONNECTOR;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_TARGET__SUBSUPERSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_TARGET__SUBSUPERSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_TARGET__SUBSUPERSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_TARGET__SUBSUPERSTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_TARGET__SIMPLESTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_TARGET__SIMPLESTATE;
				case ScchartPackage.TRANSITION___RECONNECT_TARGET__SIMPLESTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_TARGET__SIMPLESTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_TARGET__FINALSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_TARGET__FINALSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_TARGET__FINALSTATE: return ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_TARGET__FINALSTATE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_SOURCE__INITILALSUBSUPERSTATE:
				return canReconnectSource((InitilalSubSuperState)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_SOURCE__INITILALSUBSUPERSTATE:
				reconnectSource((InitilalSubSuperState)arguments.get(0));
				return null;
			case ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_SOURCE__INITIALSTATE:
				return canReconnectSource((InitialState)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_SOURCE__INITIALSTATE:
				reconnectSource((InitialState)arguments.get(0));
				return null;
			case ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_SOURCE__CONNECTOR:
				return canReconnectSource((Connector)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_SOURCE__CONNECTOR:
				reconnectSource((Connector)arguments.get(0));
				return null;
			case ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_SOURCE__SUBSUPERSTATE:
				return canReconnectSource((SubSuperState)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_SOURCE__SUBSUPERSTATE:
				reconnectSource((SubSuperState)arguments.get(0));
				return null;
			case ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_SOURCE__SIMPLESTATE:
				return canReconnectSource((SimpleState)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_SOURCE__SIMPLESTATE:
			...
			case ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_SOURCE__ROOTSTATE:
				...
				return null;
			case ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_SOURCE__FINALSTATE:
				return canReconnectSource((FinalState)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_SOURCE__FINALSTATE:
				reconnectSource((FinalState)arguments.get(0));
				return null;
			case ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_TARGET__INITILALSUBSUPERSTATE:
				return canReconnectTarget((InitilalSubSuperState)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_TARGET__INITILALSUBSUPERSTATE:
			...
			case ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_TARGET__CONNECTOR:
				...
				return null;
			case ScchartPackage.STRONG_ABORT_TRANSITION___CAN_RECONNECT_TARGET__SUBSUPERSTATE:
				return canReconnectTarget((SubSuperState)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_TRANSITION___RECONNECT_TARGET__SUBSUPERSTATE:
