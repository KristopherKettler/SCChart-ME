 ...
 * </p>
 * <ul>
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.views.impl.ImmediateStrongAbortTransitionViewImpl#getInternalImmediateStrongAbortTransition <em>Internal Immediate Strong Abort Transition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImmediateStrongAbortTransitionViewImpl extends EObjectImpl implements ImmediateStrongAbortTransitionView {
	/**
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ViewsPackage.IMMEDIATE_STRONG_ABORT_TRANSITION_VIEW___SET_EFFECT__STRING:
				...
				return null;
			case ViewsPackage.IMMEDIATE_STRONG_ABORT_TRANSITION_VIEW___GET_PRIORITY:
				return getPriority();
			case ViewsPackage.IMMEDIATE_STRONG_ABORT_TRANSITION_VIEW___SET_PRIORITY__STRING:
