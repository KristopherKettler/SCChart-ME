 ...
 * @generated
 */
public class DeferredTransitionImpl extends EdgeImpl implements DeferredTransition {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ScchartPackage.DEFERRED_TRANSITION___RECONNECT_TARGET__FINALSTATE:
			...
			case ScchartPackage.DEFERRED_TRANSITION___RECONNECT_TARGET__INITILALSUPERSTATE:
				...
				return null;
			case ScchartPackage.DEFERRED_TRANSITION___CAN_RECONNECT_TARGET__SIMPLESTATE:
