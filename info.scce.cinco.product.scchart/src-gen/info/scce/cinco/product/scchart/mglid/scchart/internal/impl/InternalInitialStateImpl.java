...
public class InternalInitialStateImpl extends InternalSimpleStateImpl implements InternalInitialState {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == InternalSimpleState.class) {
			switch (baseOperationID) {
				...
				case InternalPackage.INTERNAL_SIMPLE_STATE___GET_SUB_SUPER_STATE_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_STATE___GET_SUB_SUPER_STATE_PREDECESSORS;
				case InternalPackage.INTERNAL_SIMPLE_STATE___GET_INITILAL_SUB_SUPER_STATE_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_STATE___GET_INITILAL_SUB_SUPER_STATE_PREDECESSORS;
				...
				case InternalPackage.INTERNAL_SIMPLE_STATE___GET_SUB_SUPER_STATE_SUCCESSORS: return InternalPackage.INTERNAL_INITIAL_STATE___GET_SUB_SUPER_STATE_SUCCESSORS;
				case InternalPackage.INTERNAL_SIMPLE_STATE___GET_INITILAL_SUB_SUPER_STATE_SUCCESSORS: return InternalPackage.INTERNAL_INITIAL_STATE___GET_INITILAL_SUB_SUPER_STATE_SUCCESSORS;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case InternalPackage.INTERNAL_INITIAL_STATE___GET_SUB_SUPER_STATE_PREDECESSORS:
				return getSubSuperStatePredecessors();
			case InternalPackage.INTERNAL_INITIAL_STATE___GET_INITILAL_SUB_SUPER_STATE_PREDECESSORS:
			...
			case InternalPackage.INTERNAL_INITIAL_STATE___GET_SUB_SUPER_STATE_SUCCESSORS:
				return getSubSuperStateSuccessors();
			case InternalPackage.INTERNAL_INITIAL_STATE___GET_INITILAL_SUB_SUPER_STATE_SUCCESSORS:
