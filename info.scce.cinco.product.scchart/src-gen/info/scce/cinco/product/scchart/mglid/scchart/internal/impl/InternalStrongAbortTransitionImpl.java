...
public class InternalStrongAbortTransitionImpl extends InternalAbstractTransitionImpl implements InternalStrongAbortTransition {
	...
	public void setDelay(String newDelay) {
		...
		delay = newDelay;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_STRONG_ABORT_TRANSITION__DELAY, oldDelay, delay));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InternalPackage.INTERNAL_STRONG_ABORT_TRANSITION__CONDITION:
				return getCondition();
			case InternalPackage.INTERNAL_STRONG_ABORT_TRANSITION__DELAY:
				return getDelay();
