 ...
 * </p>
 * <ul>
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.views.InputView#getInternalInput <em>Internal Input</em>}</li>
 * </ul>
 *
 * @see info.scce.cinco.product.scchart.mglid.scchart.views.ViewsPackage#getInputView()
 * @model
 * @generated
 */
public interface InputView extends EObject {
	 ...
	 * @see info.scce.cinco.product.scchart.mglid.scchart.views.ViewsPackage#getInputView_InternalInput()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link info.scce.cinco.product.scchart.mglid.scchart.views.InputView#getInternalInput <em>Internal Input</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
