 ...
 * </p>
 * <ul>
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.internal.impl.InternalSuperStateDeclarationNodeImpl#getDeclarationType <em>Declaration Type</em>}</li>
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.internal.impl.InternalSuperStateDeclarationNodeImpl#getInputOutput <em>Input Output</em>}</li>
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.internal.impl.InternalSuperStateDeclarationNodeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InternalSuperStateDeclarationNodeImpl extends InternalNodeImpl implements InternalSuperStateDeclarationNode {
	/**
	 ...
	 * @generated
	 */
	protected InternalSuperStateDeclarationNodeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return InternalPackage.Literals.INTERNAL_SUPER_STATE_DECLARATION_NODE;
	}
	...
	public void setDeclarationType(String newDeclarationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_SUPER_STATE_DECLARATION_NODE__DECLARATION_TYPE, oldDeclarationType, declarationType));
	}
	...
	public void setInputOutput(String newInputOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_SUPER_STATE_DECLARATION_NODE__INPUT_OUTPUT, oldInputOutput, inputOutput));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_SUPER_STATE_DECLARATION_NODE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InternalPackage.INTERNAL_SUPER_STATE_DECLARATION_NODE__DECLARATION_TYPE:
				return getDeclarationType();
			case InternalPackage.INTERNAL_SUPER_STATE_DECLARATION_NODE__INPUT_OUTPUT:
				return getInputOutput();
			case InternalPackage.INTERNAL_SUPER_STATE_DECLARATION_NODE__NAME:
				return getName();
		}
...
} //InternalSuperStateDeclarationNodeImpl
