 ...
 * </p>
 * <ul>
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.views.AbstractTransitionView#getInternalAbstractTransition <em>Internal Abstract Transition</em>}</li>
 * </ul>
 *
 * @see info.scce.cinco.product.scchart.mglid.scchart.views.ViewsPackage#getAbstractTransitionView()
 * @model
 * @generated
 */
public interface AbstractTransitionView extends EObject {
	 ...
	 * @see info.scce.cinco.product.scchart.mglid.scchart.views.ViewsPackage#getAbstractTransitionView_InternalAbstractTransition()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link info.scce.cinco.product.scchart.mglid.scchart.views.AbstractTransitionView#getInternalAbstractTransition <em>Internal Abstract Transition</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
