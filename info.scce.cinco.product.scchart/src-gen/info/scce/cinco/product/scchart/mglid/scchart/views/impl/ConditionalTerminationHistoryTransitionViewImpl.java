 ...
 * </p>
 * <ul>
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.views.impl.ConditionalTerminationHistoryTransitionViewImpl#getInternalConditionalTerminationHistoryTransition <em>Internal Conditional Termination History Transition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionalTerminationHistoryTransitionViewImpl extends EObjectImpl implements ConditionalTerminationHistoryTransitionView {
	/**
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ViewsPackage.CONDITIONAL_TERMINATION_HISTORY_TRANSITION_VIEW___SET_CONDITION__STRING:
				...
				return null;
			case ViewsPackage.CONDITIONAL_TERMINATION_HISTORY_TRANSITION_VIEW___GET_DELAY:
				return getDelay();
			case ViewsPackage.CONDITIONAL_TERMINATION_HISTORY_TRANSITION_VIEW___SET_DELAY__STRING:
			...
			case ViewsPackage.CONDITIONAL_TERMINATION_HISTORY_TRANSITION_VIEW___SET_EFFECT__STRING:
				...
				return null;
			case ViewsPackage.CONDITIONAL_TERMINATION_HISTORY_TRANSITION_VIEW___GET_H:
				return getH();
			case ViewsPackage.CONDITIONAL_TERMINATION_HISTORY_TRANSITION_VIEW___SET_H__STRING:
				setH((String)arguments.get(0));
				return null;
			case ViewsPackage.CONDITIONAL_TERMINATION_HISTORY_TRANSITION_VIEW___GET_PRIORITY:
				return getPriority();
			case ViewsPackage.CONDITIONAL_TERMINATION_HISTORY_TRANSITION_VIEW___SET_PRIORITY__STRING:
