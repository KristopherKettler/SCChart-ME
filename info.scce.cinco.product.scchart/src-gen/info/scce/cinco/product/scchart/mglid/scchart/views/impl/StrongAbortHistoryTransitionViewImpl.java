 ...
 * </p>
 * <ul>
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.views.impl.StrongAbortHistoryTransitionViewImpl#getInternalStrongAbortHistoryTransition <em>Internal Strong Abort History Transition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StrongAbortHistoryTransitionViewImpl extends EObjectImpl implements StrongAbortHistoryTransitionView {
	/**
	...
	public String getDelay() {
		return getInternalStrongAbortHistoryTransition().getDelay();
	}
	...
	public void setDelay(final String _arg) {
		getInternalStrongAbortHistoryTransition().getElement().transact("Set Delay", () -> {
			getInternalStrongAbortHistoryTransition().setDelay(_arg);
		});
	...
	public String getPriority() {
		return getInternalStrongAbortHistoryTransition().getPriority();
	}
	...
	public void setPriority(final String _arg) {
		getInternalStrongAbortHistoryTransition().getElement().transact("Set Priority", () -> {
			getInternalStrongAbortHistoryTransition().setPriority(_arg);
		});
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ViewsPackage.STRONG_ABORT_HISTORY_TRANSITION_VIEW___SET_CONDITION__STRING:
				...
				return null;
			case ViewsPackage.STRONG_ABORT_HISTORY_TRANSITION_VIEW___GET_DELAY:
				return getDelay();
			case ViewsPackage.STRONG_ABORT_HISTORY_TRANSITION_VIEW___SET_DELAY__STRING:
			...
			case ViewsPackage.STRONG_ABORT_HISTORY_TRANSITION_VIEW___SET_H__STRING:
				...
				return null;
			case ViewsPackage.STRONG_ABORT_HISTORY_TRANSITION_VIEW___GET_PRIORITY:
				return getPriority();
			case ViewsPackage.STRONG_ABORT_HISTORY_TRANSITION_VIEW___SET_PRIORITY__STRING:
