 ...
 * </p>
 * <ul>
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.views.ConnectionView#getInternalConnection <em>Internal Connection</em>}</li>
 * </ul>
 *
 * @see info.scce.cinco.product.scchart.mglid.scchart.views.ViewsPackage#getConnectionView()
 * @model
 * @generated
 */
public interface ConnectionView extends EObject {
	 ...
	 * @see info.scce.cinco.product.scchart.mglid.scchart.views.ViewsPackage#getConnectionView_InternalConnection()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link info.scce.cinco.product.scchart.mglid.scchart.views.ConnectionView#getInternalConnection <em>Internal Connection</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
