...
import info.scce.cinco.product.scchart.mglid.scchart.views.InputView;
...
public class InputImpl extends NodeImpl implements Input {
	...
	public InternalInput getInternalInput() {
		return (info.scce.cinco.product.scchart.mglid.scchart.internal.InternalInput) getInternalElement();
	}
	...
	public boolean canMoveTo(final DataFlowRegion dataFlowRegion, final int x, final int y) {
		return dataFlowRegion.canContain(info.scce.cinco.product.scchart.mglid.scchart.Input.class);
	}
	...
	public InputView getInputView() {
		InputView inputView = info.scce.cinco.product.scchart.mglid.scchart.views.ViewsFactory.eINSTANCE.createInputView();
		inputView.setInternalInput((info.scce.cinco.product.scchart.mglid.scchart.internal.InternalInput)getInternalElement());
		return inputView;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ScchartPackage.INPUT___GET_CONNECTION_CIRCUIT_SUCCESSORS:
			...
			case ScchartPackage.INPUT___CAN_NEW_CONNECTION__CONNECTIONCIRCUIT:
				return canNewConnection((ConnectionCircuit)arguments.get(0));
			case ScchartPackage.INPUT___NEW_CONNECTION__CONNECTIONCIRCUIT:
				return newConnection((ConnectionCircuit)arguments.get(0));
			case ScchartPackage.INPUT___NEW_CONNECTION__CONNECTIONCIRCUIT_STRING:
