 ...
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.internal.impl.InternalConditionalTerminationHistoryTransitionImpl#getPriority <em>Priority</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InternalConditionalTerminationHistoryTransitionImpl extends InternalEdgeImpl implements InternalConditionalTerminationHistoryTransition {
	/**
	...
	public void setPriority(String newPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_CONDITIONAL_TERMINATION_HISTORY_TRANSITION__PRIORITY, oldPriority, priority));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case InternalPackage.INTERNAL_CONDITIONAL_TERMINATION_HISTORY_TRANSITION__H:
				return getH();
			case InternalPackage.INTERNAL_CONDITIONAL_TERMINATION_HISTORY_TRANSITION__PRIORITY:
				return getPriority();
		}
