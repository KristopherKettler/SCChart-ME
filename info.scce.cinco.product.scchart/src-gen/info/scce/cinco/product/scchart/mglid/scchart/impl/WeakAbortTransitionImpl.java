...
public class WeakAbortTransitionImpl extends TransitionImpl implements WeakAbortTransition {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == Transition.class) {
			switch (baseOperationID) {
				...
				case ScchartPackage.TRANSITION___CAN_RECONNECT_SOURCE__INITILALSUBSUPERSTATE: return ScchartPackage.WEAK_ABORT_TRANSITION___CAN_RECONNECT_SOURCE__INITILALSUBSUPERSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_SOURCE__INITILALSUBSUPERSTATE: return ScchartPackage.WEAK_ABORT_TRANSITION___RECONNECT_SOURCE__INITILALSUBSUPERSTATE;
				...
				case ScchartPackage.TRANSITION___CAN_RECONNECT_SOURCE__SUBSUPERSTATE: return ScchartPackage.WEAK_ABORT_TRANSITION___CAN_RECONNECT_SOURCE__SUBSUPERSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_SOURCE__SUBSUPERSTATE: return ScchartPackage.WEAK_ABORT_TRANSITION___RECONNECT_SOURCE__SUBSUPERSTATE;
				...
				case ScchartPackage.TRANSITION___CAN_RECONNECT_TARGET__INITILALSUBSUPERSTATE: return ScchartPackage.WEAK_ABORT_TRANSITION___CAN_RECONNECT_TARGET__INITILALSUBSUPERSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_TARGET__INITILALSUBSUPERSTATE: return ScchartPackage.WEAK_ABORT_TRANSITION___RECONNECT_TARGET__INITILALSUBSUPERSTATE;
				...
				case ScchartPackage.TRANSITION___CAN_RECONNECT_TARGET__SUBSUPERSTATE: return ScchartPackage.WEAK_ABORT_TRANSITION___CAN_RECONNECT_TARGET__SUBSUPERSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_TARGET__SUBSUPERSTATE: return ScchartPackage.WEAK_ABORT_TRANSITION___RECONNECT_TARGET__SUBSUPERSTATE;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ScchartPackage.WEAK_ABORT_TRANSITION___CAN_RECONNECT_SOURCE__INITILALSUBSUPERSTATE:
				return canReconnectSource((InitilalSubSuperState)arguments.get(0));
			case ScchartPackage.WEAK_ABORT_TRANSITION___RECONNECT_SOURCE__INITILALSUBSUPERSTATE:
			...
			case ScchartPackage.WEAK_ABORT_TRANSITION___RECONNECT_SOURCE__CONNECTOR:
				...
				return null;
			case ScchartPackage.WEAK_ABORT_TRANSITION___CAN_RECONNECT_SOURCE__SUBSUPERSTATE:
				return canReconnectSource((SubSuperState)arguments.get(0));
			case ScchartPackage.WEAK_ABORT_TRANSITION___RECONNECT_SOURCE__SUBSUPERSTATE:
			...
			case ScchartPackage.WEAK_ABORT_TRANSITION___RECONNECT_SOURCE__FINALSTATE:
				...
				return null;
			case ScchartPackage.WEAK_ABORT_TRANSITION___CAN_RECONNECT_TARGET__INITILALSUBSUPERSTATE:
				return canReconnectTarget((InitilalSubSuperState)arguments.get(0));
			case ScchartPackage.WEAK_ABORT_TRANSITION___RECONNECT_TARGET__INITILALSUBSUPERSTATE:
			...
			case ScchartPackage.WEAK_ABORT_TRANSITION___RECONNECT_TARGET__CONNECTOR:
				...
				return null;
			case ScchartPackage.WEAK_ABORT_TRANSITION___CAN_RECONNECT_TARGET__SUBSUPERSTATE:
				return canReconnectTarget((SubSuperState)arguments.get(0));
			case ScchartPackage.WEAK_ABORT_TRANSITION___RECONNECT_TARGET__SUBSUPERSTATE:
