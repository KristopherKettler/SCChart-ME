 ...
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.internal.impl.InternalImmediateHistoryTransitionImpl#getH <em>H</em>}</li>
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.internal.impl.InternalImmediateHistoryTransitionImpl#getPriority <em>Priority</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InternalImmediateHistoryTransitionImpl extends InternalEdgeImpl implements InternalImmediateHistoryTransition {
	/**
	 ...
	 * @generated
	 */
	protected InternalImmediateHistoryTransitionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return InternalPackage.Literals.INTERNAL_IMMEDIATE_HISTORY_TRANSITION;
	}
	...
	public void setCondition(String newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_IMMEDIATE_HISTORY_TRANSITION__CONDITION, oldCondition, condition));
	}
	...
	public void setDeepHistory(boolean newDeepHistory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_IMMEDIATE_HISTORY_TRANSITION__DEEP_HISTORY, oldDeepHistory, deepHistory));
	}
	...
	public void setEffect(String newEffect) {
		...
		effect = newEffect;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_IMMEDIATE_HISTORY_TRANSITION__EFFECT, oldEffect, effect));
	}
	...
	public void setH(String newH) {
		...
		h = newH;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_IMMEDIATE_HISTORY_TRANSITION__H, oldH, h));
	}
	...
	public void setPriority(String newPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_IMMEDIATE_HISTORY_TRANSITION__PRIORITY, oldPriority, priority));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case InternalPackage.INTERNAL_IMMEDIATE_HISTORY_TRANSITION__EFFECT:
				return getEffect();
			case InternalPackage.INTERNAL_IMMEDIATE_HISTORY_TRANSITION__H:
				return getH();
			case InternalPackage.INTERNAL_IMMEDIATE_HISTORY_TRANSITION__PRIORITY:
				return getPriority();
		}
...
} //InternalImmediateHistoryTransitionImpl
