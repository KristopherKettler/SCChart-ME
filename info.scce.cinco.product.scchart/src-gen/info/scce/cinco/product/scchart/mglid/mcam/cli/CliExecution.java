...
public class CliExecution {
	...
	private SCChartExecution fe = new SCChartExecution();
	...
	private void runMerge(String origPath, String localPath, String remotePath,
		...
		SCChartAdapter mergeModel = null;
		try {
		...
		CompareProcess<SCChartId, SCChartAdapter> localCompare = null;
		try {
		...
		CompareProcess<SCChartId, SCChartAdapter> remoteCompare = null;
		try {
			remoteCompare = fe
		...
		MergeProcess<SCChartId, SCChartAdapter> mp = null;
		try {
		...
		CheckProcess<SCChartId, SCChartAdapter> cp = null;
		try {
	...
	private void runCompare(String origPath, String localPath) {
		...
		try {
			CompareProcess<SCChartId, SCChartAdapter> compare = fe
	...
	private void runCheck(String filePath) {
		...
		try {
			...
			CheckProcess<SCChartId, SCChartAdapter> check = fe
			...
			ArrayList<SCChartAdapter> models = new ArrayList<>();
			models.add(model1);
