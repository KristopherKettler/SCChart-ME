...
import info.scce.cinco.product.scchart.mglid.scchart.views.AssignmentView;
 ...
 * </p>
 * <ul>
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.impl.AssignmentImpl#getId <em>Id</em>}</li>
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.impl.AssignmentImpl#getInternalElement <em>Internal Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssignmentImpl extends EObjectImpl implements Assignment {
	...
	public AssignmentView getAssignmentView() {
		AssignmentView assignmentView = info.scce.cinco.product.scchart.mglid.scchart.views.ViewsFactory.eINSTANCE.createAssignmentView();
		assignmentView.setInternalAssignment((info.scce.cinco.product.scchart.mglid.scchart.internal.InternalAssignment)getInternalElement());
