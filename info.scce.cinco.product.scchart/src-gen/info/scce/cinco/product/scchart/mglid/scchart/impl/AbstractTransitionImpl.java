...
public class AbstractTransitionImpl extends EdgeImpl implements AbstractTransition {
	...
	public InternalAbstractTransition getInternalAbstractTransition() {
		return (info.scce.cinco.product.scchart.mglid.scchart.internal.InternalAbstractTransition) getInternalElement();
	}
	...
	public AbstractTransitionView getAbstractTransitionView() {
		AbstractTransitionView abstractTransitionView = info.scce.cinco.product.scchart.mglid.scchart.views.ViewsFactory.eINSTANCE.createAbstractTransitionView();
		abstractTransitionView.setInternalAbstractTransition((info.scce.cinco.product.scchart.mglid.scchart.internal.InternalAbstractTransition)getInternalElement());
