...
public class RootStateImpl extends ModelElementContainerImpl implements RootState {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ScchartPackage.ROOT_STATE___CAN_NEW_CONNECTION__INITILALSUPERSTATE:
				return canNewConnection((InitilalSuperState)arguments.get(0));
			case ScchartPackage.ROOT_STATE___NEW_CONNECTION__INITILALSUPERSTATE:
				return newConnection((InitilalSuperState)arguments.get(0));
			case ScchartPackage.ROOT_STATE___NEW_CONNECTION__INITILALSUPERSTATE_STRING:
