...
public class SuperStateImpl extends ModelElementContainerImpl implements SuperState {
	 ...
	 */
	@Override
	public boolean canNewConnection(final InitilalSuperState target) {
	 ...
	 */
	@Override
	public Connection newConnection(final InitilalSuperState target) {
	 ...
	 */
	@Override
	public Connection newConnection(final InitilalSuperState target, final String id) {
		if (!this.canStart(info.scce.cinco.product.scchart.mglid.scchart.Connection.class))
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ScchartPackage.SUPER_STATE___GET_OUTGOING_CONNECTIONS:
			...
			case ScchartPackage.SUPER_STATE___GET_INCOMING_CONNECTIONS:
			...
			case ScchartPackage.SUPER_STATE___CAN_NEW_CONNECTION__INITILALSUPERSTATE:
				return canNewConnection((InitilalSuperState)arguments.get(0));
			case ScchartPackage.SUPER_STATE___NEW_CONNECTION__INITILALSUPERSTATE:
				return newConnection((InitilalSuperState)arguments.get(0));
			case ScchartPackage.SUPER_STATE___NEW_CONNECTION__INITILALSUPERSTATE_STRING:
				return newConnection((InitilalSuperState)arguments.get(0), (String)arguments.get(1));
