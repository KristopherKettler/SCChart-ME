	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___SET_CONDITION__STRING:
				...
				return null;
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___GET_COUNT_DELAY:
				return getCount_delay();
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___SET_COUNT_DELAY__STRING:
			...
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___RECONNECT_SOURCE__INITILALSUPERSTATE:
				...
				return null;
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___CAN_RECONNECT_SOURCE__INITIALSCCHARTREFERECE:
				return canReconnectSource((InitialSCChartReferece)arguments.get(0));
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___RECONNECT_SOURCE__INITIALSCCHARTREFERECE:
			...
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___RECONNECT_SOURCE__ROOTSTATE:
				...
				return null;
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___CAN_RECONNECT_SOURCE__FINALSUPERSTATE:
				return canReconnectSource((FinalSuperState)arguments.get(0));
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___RECONNECT_SOURCE__FINALSUPERSTATE:
			...
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___RECONNECT_SOURCE__SUPERSTATE:
				...
				return null;
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___CAN_RECONNECT_SOURCE__FINALSCCHARTREFERECE:
				return canReconnectSource((FinalSCChartReferece)arguments.get(0));
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___RECONNECT_SOURCE__FINALSCCHARTREFERECE:
				reconnectSource((FinalSCChartReferece)arguments.get(0));
				return null;
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___CAN_RECONNECT_SOURCE__SCCHARTREFERECE:
				return canReconnectSource((SCChartReferece)arguments.get(0));
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___RECONNECT_SOURCE__SCCHARTREFERECE:
			...
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___RECONNECT_TARGET__INITILALSUPERSTATE:
				...
				return null;
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___CAN_RECONNECT_TARGET__INITIALSCCHARTREFERECE:
				return canReconnectTarget((InitialSCChartReferece)arguments.get(0));
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___RECONNECT_TARGET__INITIALSCCHARTREFERECE:
				reconnectTarget((InitialSCChartReferece)arguments.get(0));
				return null;
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___CAN_RECONNECT_TARGET__FINALSUPERSTATE:
				return canReconnectTarget((FinalSuperState)arguments.get(0));
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___RECONNECT_TARGET__FINALSUPERSTATE:
			...
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___RECONNECT_TARGET__SUPERSTATE:
				...
				return null;
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___CAN_RECONNECT_TARGET__FINALSCCHARTREFERECE:
				return canReconnectTarget((FinalSCChartReferece)arguments.get(0));
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___RECONNECT_TARGET__FINALSCCHARTREFERECE:
				reconnectTarget((FinalSCChartReferece)arguments.get(0));
				return null;
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___CAN_RECONNECT_TARGET__SCCHARTREFERECE:
				return canReconnectTarget((SCChartReferece)arguments.get(0));
			case ScchartPackage.IMMEDIATE_STRONG_ABORT_DEFERRED_TRANSITION___RECONNECT_TARGET__SCCHARTREFERECE:
