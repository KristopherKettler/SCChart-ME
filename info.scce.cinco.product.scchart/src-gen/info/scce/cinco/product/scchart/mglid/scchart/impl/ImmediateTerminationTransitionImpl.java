 ...
 * @generated
 */
public class ImmediateTerminationTransitionImpl extends TransitionImpl implements ImmediateTerminationTransition {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == Transition.class) {
			switch (baseOperationID) {
				case ScchartPackage.TRANSITION___PRE_DELETE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___PRE_DELETE;
				case ScchartPackage.TRANSITION___GET_POST_DELETE_FUNCTION: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___GET_POST_DELETE_FUNCTION;
				case ScchartPackage.TRANSITION___GET_POST_DELETE_EVENT: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___GET_POST_DELETE_EVENT;
				case ScchartPackage.TRANSITION___PRE_SAVE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___PRE_SAVE;
				case ScchartPackage.TRANSITION___POST_SAVE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___POST_SAVE;
				case ScchartPackage.TRANSITION___GET_ROOT_ELEMENT: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___GET_ROOT_ELEMENT;
				case ScchartPackage.TRANSITION___GET_SOURCE_ELEMENT: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___GET_SOURCE_ELEMENT;
				case ScchartPackage.TRANSITION___GET_TARGET_ELEMENT: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___GET_TARGET_ELEMENT;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_SOURCE__SIMPLESTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___CAN_RECONNECT_SOURCE__SIMPLESTATE;
				case ScchartPackage.TRANSITION___RECONNECT_SOURCE__SIMPLESTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_SOURCE__SIMPLESTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_SOURCE__CONNECTOR: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___CAN_RECONNECT_SOURCE__CONNECTOR;
				case ScchartPackage.TRANSITION___RECONNECT_SOURCE__CONNECTOR: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_SOURCE__CONNECTOR;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_SOURCE__INITILALSUPERSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___CAN_RECONNECT_SOURCE__INITILALSUPERSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_SOURCE__INITILALSUPERSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_SOURCE__INITILALSUPERSTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_SOURCE__ROOTSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___CAN_RECONNECT_SOURCE__ROOTSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_SOURCE__ROOTSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_SOURCE__ROOTSTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_SOURCE__INITIALSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___CAN_RECONNECT_SOURCE__INITIALSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_SOURCE__INITIALSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_SOURCE__INITIALSTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_SOURCE__SUPERSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___CAN_RECONNECT_SOURCE__SUPERSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_SOURCE__SUPERSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_SOURCE__SUPERSTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_SOURCE__FINALSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___CAN_RECONNECT_SOURCE__FINALSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_SOURCE__FINALSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_SOURCE__FINALSTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_TARGET__SIMPLESTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___CAN_RECONNECT_TARGET__SIMPLESTATE;
				case ScchartPackage.TRANSITION___RECONNECT_TARGET__SIMPLESTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_TARGET__SIMPLESTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_TARGET__CONNECTOR: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___CAN_RECONNECT_TARGET__CONNECTOR;
				case ScchartPackage.TRANSITION___RECONNECT_TARGET__CONNECTOR: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_TARGET__CONNECTOR;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_TARGET__INITILALSUPERSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___CAN_RECONNECT_TARGET__INITILALSUPERSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_TARGET__INITILALSUPERSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_TARGET__INITILALSUPERSTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_TARGET__INITIALSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___CAN_RECONNECT_TARGET__INITIALSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_TARGET__INITIALSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_TARGET__INITIALSTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_TARGET__SUPERSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___CAN_RECONNECT_TARGET__SUPERSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_TARGET__SUPERSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_TARGET__SUPERSTATE;
				case ScchartPackage.TRANSITION___CAN_RECONNECT_TARGET__FINALSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___CAN_RECONNECT_TARGET__FINALSTATE;
				case ScchartPackage.TRANSITION___RECONNECT_TARGET__FINALSTATE: return ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_TARGET__FINALSTATE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_SOURCE__CONNECTOR:
				...
				return null;
			case ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___CAN_RECONNECT_SOURCE__INITILALSUPERSTATE:
				return canReconnectSource((InitilalSuperState)arguments.get(0));
			case ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_SOURCE__INITILALSUPERSTATE:
			...
			case ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_SOURCE__INITIALSTATE:
				...
				return null;
			case ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___CAN_RECONNECT_SOURCE__SUPERSTATE:
				return canReconnectSource((SuperState)arguments.get(0));
			case ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_SOURCE__SUPERSTATE:
			...
			case ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_TARGET__CONNECTOR:
				...
				return null;
			case ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___CAN_RECONNECT_TARGET__INITILALSUPERSTATE:
				return canReconnectTarget((InitilalSuperState)arguments.get(0));
			case ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_TARGET__INITILALSUPERSTATE:
			...
			case ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_TARGET__INITIALSTATE:
				...
				return null;
			case ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___CAN_RECONNECT_TARGET__SUPERSTATE:
				return canReconnectTarget((SuperState)arguments.get(0));
			case ScchartPackage.IMMEDIATE_TERMINATION_TRANSITION___RECONNECT_TARGET__SUPERSTATE:
