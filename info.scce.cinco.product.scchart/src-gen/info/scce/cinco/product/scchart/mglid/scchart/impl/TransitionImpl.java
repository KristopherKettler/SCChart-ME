...
public class TransitionImpl extends EdgeImpl implements Transition {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ScchartPackage.TRANSITION___CAN_RECONNECT_SOURCE__INITILALSUBSUPERSTATE:
			...
			case ScchartPackage.TRANSITION___RECONNECT_SOURCE__FINALSTATE:
				...
				return null;
			case ScchartPackage.TRANSITION___CAN_RECONNECT_TARGET__INITILALSUBSUPERSTATE:
