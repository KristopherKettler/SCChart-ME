 ...
 * </p>
 * <ul>
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.impl.SubSuperStateRegionImpl#getInternalElement <em>Internal Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubSuperStateRegionImpl extends ModelElementContainerImpl implements SubSuperStateRegion {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected SubSuperStateRegionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ScchartPackage.eINSTANCE.getSubSuperStateRegion();
	}
	...
	public InternalModelElement getInternalElement() {
		if (eContainerFeatureID() != ScchartPackage.SUB_SUPER_STATE_REGION__INTERNAL_ELEMENT) return null;
	...
	public NotificationChain basicSetInternalElement(InternalModelElement newInternalElement, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newInternalElement, ScchartPackage.SUB_SUPER_STATE_REGION__INTERNAL_ELEMENT, msgs);
		return msgs;
	}
	...
	public void setInternalElement(InternalModelElement newInternalElement) {
		if (newInternalElement != eInternalContainer() || (eContainerFeatureID() != ScchartPackage.SUB_SUPER_STATE_REGION__INTERNAL_ELEMENT && newInternalElement != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ScchartPackage.SUB_SUPER_STATE_REGION__INTERNAL_ELEMENT, newInternalElement, newInternalElement));
	}
	...
	public InternalSubSuperStateRegion getInternalSubSuperStateRegion() {
		return (info.scce.cinco.product.scchart.mglid.scchart.internal.InternalSubSuperStateRegion) getInternalElement();
	}
	 ...
	 */
	@Override
	public boolean isExactlySubSuperStateRegion() {
		return true;
	}
	...
	public boolean canMoveTo(final SubSuperState subSuperState, final int x, final int y) {
		return subSuperState.canContain(info.scce.cinco.product.scchart.mglid.scchart.SubSuperStateRegion.class);
	}
	...
	public boolean canMoveTo(final InitilalSubSuperState initilalSubSuperState, final int x, final int y) {
		return initilalSubSuperState.canContain(info.scce.cinco.product.scchart.mglid.scchart.SubSuperStateRegion.class);
	}
	...
	public boolean canMoveTo(final SubSuperStateRegion subSuperStateRegion, final int x, final int y) {
		return subSuperStateRegion.canContain(info.scce.cinco.product.scchart.mglid.scchart.SubSuperStateRegion.class);
	}
	 ...
	 */
	@Override
	public SubSuperStateRegionView getSubSuperStateRegionView() {
		SubSuperStateRegionView subSuperStateRegionView = info.scce.cinco.product.scchart.mglid.scchart.views.ViewsFactory.eINSTANCE.createSubSuperStateRegionView();
		subSuperStateRegionView.setInternalSubSuperStateRegion((info.scce.cinco.product.scchart.mglid.scchart.internal.InternalSubSuperStateRegion)getInternalElement());
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ScchartPackage.SUB_SUPER_STATE_REGION__INTERNAL_ELEMENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ModelElement.class) {
			switch (derivedFeatureID) {
				case ScchartPackage.SUB_SUPER_STATE_REGION__INTERNAL_ELEMENT: return GraphmodelPackage.MODEL_ELEMENT__INTERNAL_ELEMENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ModelElement.class) {
			switch (baseFeatureID) {
				case GraphmodelPackage.MODEL_ELEMENT__INTERNAL_ELEMENT: return ScchartPackage.SUB_SUPER_STATE_REGION__INTERNAL_ELEMENT;
				default: return -1;
			}
		}
		if (baseClass == Node.class) {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == IdentifiableElement.class) {
			switch (baseOperationID) {
				case GraphmodelPackage.IDENTIFIABLE_ELEMENT___PRE_SAVE: return ScchartPackage.SUB_SUPER_STATE_REGION___PRE_SAVE;
				case GraphmodelPackage.IDENTIFIABLE_ELEMENT___POST_SAVE: return ScchartPackage.SUB_SUPER_STATE_REGION___POST_SAVE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == ModelElementContainer.class) {
			switch (baseOperationID) {
				case GraphmodelPackage.MODEL_ELEMENT_CONTAINER___GET_INTERNAL_CONTAINER_ELEMENT: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_INTERNAL_CONTAINER_ELEMENT;
				case GraphmodelPackage.MODEL_ELEMENT_CONTAINER___GET_NODES: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_NODES;
				case GraphmodelPackage.MODEL_ELEMENT_CONTAINER___PRE_SAVE: return ScchartPackage.SUB_SUPER_STATE_REGION___PRE_SAVE;
				case GraphmodelPackage.MODEL_ELEMENT_CONTAINER___POST_SAVE: return ScchartPackage.SUB_SUPER_STATE_REGION___POST_SAVE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == ModelElement.class) {
			switch (baseOperationID) {
				case GraphmodelPackage.MODEL_ELEMENT___GET_CONTAINER: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_CONTAINER;
				case GraphmodelPackage.MODEL_ELEMENT___GET_ROOT_ELEMENT: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_ROOT_ELEMENT;
				case GraphmodelPackage.MODEL_ELEMENT___HIGHLIGHT: return ScchartPackage.SUB_SUPER_STATE_REGION___HIGHLIGHT;
				case GraphmodelPackage.MODEL_ELEMENT___UPDATE: return ScchartPackage.SUB_SUPER_STATE_REGION___UPDATE;
				case GraphmodelPackage.MODEL_ELEMENT___UPDATE_GRAPH_MODEL: return ScchartPackage.SUB_SUPER_STATE_REGION___UPDATE_GRAPH_MODEL;
				default: return -1;
			}
		}
		if (baseClass == Node.class) {
			switch (baseOperationID) {
				case GraphmodelPackage.NODE___GET_SUCCESSORS: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_SUCCESSORS;
				case GraphmodelPackage.NODE___GET_SUCCESSORS__CLASS: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_SUCCESSORS__CLASS;
				case GraphmodelPackage.NODE___GET_PREDECESSORS: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_PREDECESSORS;
				case GraphmodelPackage.NODE___GET_PREDECESSORS__CLASS: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_PREDECESSORS__CLASS;
				case GraphmodelPackage.NODE___GET_INCOMING__CLASS: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_INCOMING__CLASS;
				case GraphmodelPackage.NODE___GET_OUTGOING__CLASS: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_OUTGOING__CLASS;
				case GraphmodelPackage.NODE___CAN_CONNECT__EDGE_NODE: return ScchartPackage.SUB_SUPER_STATE_REGION___CAN_CONNECT__EDGE_NODE;
				case GraphmodelPackage.NODE___GET_OUTGOING_CONSTRAINTS: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_OUTGOING_CONSTRAINTS;
				case GraphmodelPackage.NODE___GET_INCOMING_CONSTRAINTS: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_INCOMING_CONSTRAINTS;
				case GraphmodelPackage.NODE___CAN_START__CLASS: return ScchartPackage.SUB_SUPER_STATE_REGION___CAN_START__CLASS;
				case GraphmodelPackage.NODE___CAN_END__CLASS: return ScchartPackage.SUB_SUPER_STATE_REGION___CAN_END__CLASS;
				case GraphmodelPackage.NODE___MOVE__INT_INT: return ScchartPackage.SUB_SUPER_STATE_REGION___MOVE__INT_INT;
				case GraphmodelPackage.NODE___RESIZE__INT_INT: return ScchartPackage.SUB_SUPER_STATE_REGION___RESIZE__INT_INT;
				case GraphmodelPackage.NODE___RESIZE__INT_INT_INT_INT: return ScchartPackage.SUB_SUPER_STATE_REGION___RESIZE__INT_INT_INT_INT;
				case GraphmodelPackage.NODE___PRE_MOVE__MODELELEMENTCONTAINER_INT_INT: return ScchartPackage.SUB_SUPER_STATE_REGION___PRE_MOVE__MODELELEMENTCONTAINER_INT_INT;
				case GraphmodelPackage.NODE___POST_MOVE__MODELELEMENTCONTAINER_MODELELEMENTCONTAINER_INT_INT_INT_INT: return ScchartPackage.SUB_SUPER_STATE_REGION___POST_MOVE__MODELELEMENTCONTAINER_MODELELEMENTCONTAINER_INT_INT_INT_INT;
				case GraphmodelPackage.NODE___DELETE: return ScchartPackage.SUB_SUPER_STATE_REGION___DELETE;
				case GraphmodelPackage.NODE___GET_POST_DELETE_FUNCTION: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_POST_DELETE_FUNCTION;
				case GraphmodelPackage.NODE___GET_POST_DELETE_EVENT: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_POST_DELETE_EVENT;
				case GraphmodelPackage.NODE___PRE_DELETE: return ScchartPackage.SUB_SUPER_STATE_REGION___PRE_DELETE;
				case GraphmodelPackage.NODE___CAN_MOVE_TO__MODELELEMENTCONTAINER: return ScchartPackage.SUB_SUPER_STATE_REGION___CAN_MOVE_TO__MODELELEMENTCONTAINER;
				case GraphmodelPackage.NODE___MOVE_TO__MODELELEMENTCONTAINER_INT_INT: return ScchartPackage.SUB_SUPER_STATE_REGION___MOVE_TO__MODELELEMENTCONTAINER_INT_INT;
				case GraphmodelPackage.NODE___CAN_CLONE__MODELELEMENTCONTAINER: return ScchartPackage.SUB_SUPER_STATE_REGION___CAN_CLONE__MODELELEMENTCONTAINER;
				case GraphmodelPackage.NODE___CLONE__MODELELEMENTCONTAINER: return ScchartPackage.SUB_SUPER_STATE_REGION___CLONE__MODELELEMENTCONTAINER;
				case GraphmodelPackage.NODE___GET_X: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_X;
				case GraphmodelPackage.NODE___GET_Y: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_Y;
				case GraphmodelPackage.NODE___GET_WIDTH: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_WIDTH;
				case GraphmodelPackage.NODE___GET_HEIGHT: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_HEIGHT;
				case GraphmodelPackage.NODE___COPY__MODELELEMENTCONTAINER: return ScchartPackage.SUB_SUPER_STATE_REGION___COPY__MODELELEMENTCONTAINER;
				case GraphmodelPackage.NODE___SET_X__INT: return ScchartPackage.SUB_SUPER_STATE_REGION___SET_X__INT;
				case GraphmodelPackage.NODE___SET_Y__INT: return ScchartPackage.SUB_SUPER_STATE_REGION___SET_Y__INT;
				case GraphmodelPackage.NODE___SET_WIDTH__INT: return ScchartPackage.SUB_SUPER_STATE_REGION___SET_WIDTH__INT;
				case GraphmodelPackage.NODE___SET_HEIGHT__INT: return ScchartPackage.SUB_SUPER_STATE_REGION___SET_HEIGHT__INT;
				case GraphmodelPackage.NODE___PRE_RESIZE__INT_INT_INT_INT_DIRECTION: return ScchartPackage.SUB_SUPER_STATE_REGION___PRE_RESIZE__INT_INT_INT_INT_DIRECTION;
				case GraphmodelPackage.NODE___POST_RESIZE__INT_INT_INT_INT_DIRECTION: return ScchartPackage.SUB_SUPER_STATE_REGION___POST_RESIZE__INT_INT_INT_INT_DIRECTION;
				case GraphmodelPackage.NODE___GET_LAYER: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_LAYER;
				case GraphmodelPackage.NODE___SMOVE_TO__MODELELEMENTCONTAINER_INT_INT: return ScchartPackage.SUB_SUPER_STATE_REGION___SMOVE_TO__MODELELEMENTCONTAINER_INT_INT;
				case GraphmodelPackage.NODE___GET_INCOMING: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_INCOMING;
				case GraphmodelPackage.NODE___GET_OUTGOING: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_OUTGOING;
				case GraphmodelPackage.NODE___GET_UNTYPED_INCOMING: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_UNTYPED_INCOMING;
				case GraphmodelPackage.NODE___GET_UNTYPED_OUTGOING: return ScchartPackage.SUB_SUPER_STATE_REGION___GET_UNTYPED_OUTGOING;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_REGION_ID:
				return getRegionID();
			case ScchartPackage.SUB_SUPER_STATE_REGION___SET_REGION_ID__STRING:
				setRegionID((String)arguments.get(0));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_INTERNAL_SUB_SUPER_STATE_REGION:
				return getInternalSubSuperStateRegion();
			case ScchartPackage.SUB_SUPER_STATE_REGION___IS_EXACTLY_SUB_SUPER_STATE_REGION:
				return isExactlySubSuperStateRegion();
			case ScchartPackage.SUB_SUPER_STATE_REGION___PRE_DELETE:
				preDelete();
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_POST_DELETE_FUNCTION:
				return getPostDeleteFunction();
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_POST_DELETE_EVENT:
				return getPostDeleteEvent();
			case ScchartPackage.SUB_SUPER_STATE_REGION___PRE_SAVE:
				preSave();
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___POST_SAVE:
				postSave();
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_ROOT_ELEMENT:
			...
			case ScchartPackage.SUB_SUPER_STATE_REGION___NEW_SUB_SUPER_STATE_REGION__INT_INT:
				return newSubSuperStateRegion((Integer)arguments.get(0), (Integer)arguments.get(1));
			case ScchartPackage.SUB_SUPER_STATE_REGION___NEW_SUB_SUPER_STATE_REGION__STRING_INT_INT:
				return newSubSuperStateRegion((String)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case ScchartPackage.SUB_SUPER_STATE_REGION___NEW_SUB_SUPER_STATE_REGION__INT_INT_INT_INT:
			...
			case ScchartPackage.SUB_SUPER_STATE_REGION___NEW_FINAL_STATE__INT_INT:
				return newFinalState((Integer)arguments.get(0), (Integer)arguments.get(1));
			case ScchartPackage.SUB_SUPER_STATE_REGION___NEW_FINAL_STATE__STRING_INT_INT:
				return newFinalState((String)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case ScchartPackage.SUB_SUPER_STATE_REGION___NEW_FINAL_STATE__INT_INT_INT_INT:
			...
			case ScchartPackage.SUB_SUPER_STATE_REGION___NEW_INITIAL_STATE__INT_INT:
				return newInitialState((Integer)arguments.get(0), (Integer)arguments.get(1));
			case ScchartPackage.SUB_SUPER_STATE_REGION___NEW_INITIAL_STATE__STRING_INT_INT:
				return newInitialState((String)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case ScchartPackage.SUB_SUPER_STATE_REGION___NEW_INITIAL_STATE__INT_INT_INT_INT:
				return newInitialState((Integer)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2), (Integer)arguments.get(3));
			case ScchartPackage.SUB_SUPER_STATE_REGION___NEW_INITIAL_STATE__STRING_INT_INT_INT_INT:
			...
			case ScchartPackage.SUB_SUPER_STATE_REGION___NEW_SUB_SUPER_STATE__INT_INT:
				return newSubSuperState((Integer)arguments.get(0), (Integer)arguments.get(1));
			case ScchartPackage.SUB_SUPER_STATE_REGION___NEW_SUB_SUPER_STATE__STRING_INT_INT:
				return newSubSuperState((String)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case ScchartPackage.SUB_SUPER_STATE_REGION___NEW_SUB_SUPER_STATE__INT_INT_INT_INT:
			...
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_SUB_SUPER_STATE_DECLARATION_NODES:
				return getSubSuperStateDeclarationNodes();
			case ScchartPackage.SUB_SUPER_STATE_REGION___CAN_NEW_SUB_SUPER_STATE_DECLARATION_NODE:
				return canNewSubSuperStateDeclarationNode();
			case ScchartPackage.SUB_SUPER_STATE_REGION___NEW_SUB_SUPER_STATE_DECLARATION_NODE__INT_INT:
				return newSubSuperStateDeclarationNode((Integer)arguments.get(0), (Integer)arguments.get(1));
			case ScchartPackage.SUB_SUPER_STATE_REGION___NEW_SUB_SUPER_STATE_DECLARATION_NODE__STRING_INT_INT:
				return newSubSuperStateDeclarationNode((String)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case ScchartPackage.SUB_SUPER_STATE_REGION___NEW_SUB_SUPER_STATE_DECLARATION_NODE__INT_INT_INT_INT:
			...
			case ScchartPackage.SUB_SUPER_STATE_REGION___SMOVE_TO__MODELELEMENTCONTAINER_INT_INT:
				...
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___PRE_MOVE__MODELELEMENTCONTAINER_INT_INT:
				preMove((ModelElementContainer)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___POST_MOVE__MODELELEMENTCONTAINER_MODELELEMENTCONTAINER_INT_INT_INT_INT:
				postMove((ModelElementContainer)arguments.get(0), (ModelElementContainer)arguments.get(1), (Integer)arguments.get(2), (Integer)arguments.get(3), (Integer)arguments.get(4), (Integer)arguments.get(5));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___PRE_RESIZE__INT_INT_INT_INT_DIRECTION:
				preResize((Integer)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2), (Integer)arguments.get(3), (Direction)arguments.get(4));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___POST_RESIZE__INT_INT_INT_INT_DIRECTION:
				postResize((Integer)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2), (Integer)arguments.get(3), (Direction)arguments.get(4));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___CAN_MOVE_TO__SUBSUPERSTATE_INT_INT:
				return canMoveTo((SubSuperState)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case ScchartPackage.SUB_SUPER_STATE_REGION___MOVE_TO__SUBSUPERSTATE_INT_INT:
				moveTo((SubSuperState)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___SMOVE_TO__SUBSUPERSTATE_INT_INT:
				s_moveTo((SubSuperState)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___CAN_MOVE_TO__INITILALSUBSUPERSTATE_INT_INT:
				return canMoveTo((InitilalSubSuperState)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case ScchartPackage.SUB_SUPER_STATE_REGION___MOVE_TO__INITILALSUBSUPERSTATE_INT_INT:
				moveTo((InitilalSubSuperState)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___SMOVE_TO__INITILALSUBSUPERSTATE_INT_INT:
				s_moveTo((InitilalSubSuperState)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___CAN_MOVE_TO__SUBSUPERSTATEREGION_INT_INT:
				return canMoveTo((SubSuperStateRegion)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case ScchartPackage.SUB_SUPER_STATE_REGION___MOVE_TO__SUBSUPERSTATEREGION_INT_INT:
				moveTo((SubSuperStateRegion)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___SMOVE_TO__SUBSUPERSTATEREGION_INT_INT:
				s_moveTo((SubSuperStateRegion)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_SUB_SUPER_STATE_REGION_VIEW:
				return getSubSuperStateRegionView();
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_INTERNAL_CONTAINER_ELEMENT:
				return getInternalContainerElement();
			case ScchartPackage.SUB_SUPER_STATE_REGION___DELETE:
				delete();
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_SUCCESSORS:
				return getSuccessors();
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_SUCCESSORS__CLASS:
				return getSuccessors((Class)arguments.get(0));
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_PREDECESSORS:
				return getPredecessors();
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_PREDECESSORS__CLASS:
				return getPredecessors((Class)arguments.get(0));
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_INCOMING__CLASS:
				return getIncoming((Class)arguments.get(0));
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_OUTGOING__CLASS:
				return getOutgoing((Class)arguments.get(0));
			case ScchartPackage.SUB_SUPER_STATE_REGION___CAN_CONNECT__EDGE_NODE:
				return canConnect((Edge)arguments.get(0), (Node)arguments.get(1));
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_OUTGOING_CONSTRAINTS:
				return getOutgoingConstraints();
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_INCOMING_CONSTRAINTS:
				return getIncomingConstraints();
			case ScchartPackage.SUB_SUPER_STATE_REGION___CAN_START__CLASS:
				return canStart((Class<? extends Edge>)arguments.get(0));
			case ScchartPackage.SUB_SUPER_STATE_REGION___CAN_END__CLASS:
				return canEnd((Class<? extends Edge>)arguments.get(0));
			case ScchartPackage.SUB_SUPER_STATE_REGION___MOVE__INT_INT:
				move((Integer)arguments.get(0), (Integer)arguments.get(1));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___RESIZE__INT_INT:
				resize((Integer)arguments.get(0), (Integer)arguments.get(1));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___RESIZE__INT_INT_INT_INT:
				resize((Integer)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2), (Integer)arguments.get(3));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___CAN_MOVE_TO__MODELELEMENTCONTAINER:
				return canMoveTo((ModelElementContainer)arguments.get(0));
			case ScchartPackage.SUB_SUPER_STATE_REGION___MOVE_TO__MODELELEMENTCONTAINER_INT_INT:
				moveTo((ModelElementContainer)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___CAN_CLONE__MODELELEMENTCONTAINER:
				return canClone((ModelElementContainer)arguments.get(0));
			case ScchartPackage.SUB_SUPER_STATE_REGION___CLONE__MODELELEMENTCONTAINER:
				return clone((ModelElementContainer)arguments.get(0));
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_X:
				return getX();
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_Y:
				return getY();
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_WIDTH:
				return getWidth();
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_HEIGHT:
				return getHeight();
			case ScchartPackage.SUB_SUPER_STATE_REGION___COPY__MODELELEMENTCONTAINER:
				return copy((ModelElementContainer)arguments.get(0));
			case ScchartPackage.SUB_SUPER_STATE_REGION___SET_X__INT:
				setX((Integer)arguments.get(0));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___SET_Y__INT:
				setY((Integer)arguments.get(0));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___SET_WIDTH__INT:
				setWidth((Integer)arguments.get(0));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___SET_HEIGHT__INT:
				setHeight((Integer)arguments.get(0));
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_LAYER:
				return getLayer();
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_INCOMING:
				return getIncoming();
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_OUTGOING:
				return getOutgoing();
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_UNTYPED_INCOMING:
				return getUntypedIncoming();
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_UNTYPED_OUTGOING:
				return getUntypedOutgoing();
			case ScchartPackage.SUB_SUPER_STATE_REGION___GET_CONTAINER:
				return getContainer();
			case ScchartPackage.SUB_SUPER_STATE_REGION___HIGHLIGHT:
				highlight();
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___UPDATE:
				update();
				return null;
			case ScchartPackage.SUB_SUPER_STATE_REGION___UPDATE_GRAPH_MODEL:
				updateGraphModel();
				return null;
		}
