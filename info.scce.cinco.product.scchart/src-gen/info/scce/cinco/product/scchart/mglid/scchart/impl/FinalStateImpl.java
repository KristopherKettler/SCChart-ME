...
public class FinalStateImpl extends SimpleStateImpl implements FinalState {
	...
	public boolean canMoveTo(final SCChartReferece sCChartReferece, final int x, final int y) {
		return sCChartReferece.canContain(info.scce.cinco.product.scchart.mglid.scchart.FinalState.class);
	}
	...
	public boolean canMoveTo(final InitialSCChartReferece initialSCChartReferece, final int x, final int y) {
		return initialSCChartReferece.canContain(info.scce.cinco.product.scchart.mglid.scchart.FinalState.class);
	}
	...
	public boolean canMoveTo(final FinalSCChartReferece finalSCChartReferece, final int x, final int y) {
		return finalSCChartReferece.canContain(info.scce.cinco.product.scchart.mglid.scchart.FinalState.class);
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == SimpleState.class) {
			switch (baseOperationID) {
				...
				case ScchartPackage.SIMPLE_STATE___CAN_NEW_IMMEDIATE_TRANSITION__INITIALSCCHARTREFERECE: return ScchartPackage.FINAL_STATE___CAN_NEW_IMMEDIATE_TRANSITION__INITIALSCCHARTREFERECE;
				case ScchartPackage.SIMPLE_STATE___NEW_IMMEDIATE_TRANSITION__INITIALSCCHARTREFERECE: return ScchartPackage.FINAL_STATE___NEW_IMMEDIATE_TRANSITION__INITIALSCCHARTREFERECE;
				case ScchartPackage.SIMPLE_STATE___NEW_IMMEDIATE_TRANSITION__INITIALSCCHARTREFERECE_STRING: return ScchartPackage.FINAL_STATE___NEW_IMMEDIATE_TRANSITION__INITIALSCCHARTREFERECE_STRING;
				...
				case ScchartPackage.SIMPLE_STATE___CAN_NEW_IMMEDIATE_TRANSITION__FINALSCCHARTREFERECE: return ScchartPackage.FINAL_STATE___CAN_NEW_IMMEDIATE_TRANSITION__FINALSCCHARTREFERECE;
				case ScchartPackage.SIMPLE_STATE___NEW_IMMEDIATE_TRANSITION__FINALSCCHARTREFERECE: return ScchartPackage.FINAL_STATE___NEW_IMMEDIATE_TRANSITION__FINALSCCHARTREFERECE;
				case ScchartPackage.SIMPLE_STATE___NEW_IMMEDIATE_TRANSITION__FINALSCCHARTREFERECE_STRING: return ScchartPackage.FINAL_STATE___NEW_IMMEDIATE_TRANSITION__FINALSCCHARTREFERECE_STRING;
				case ScchartPackage.SIMPLE_STATE___CAN_NEW_IMMEDIATE_TRANSITION__SCCHARTREFERECE: return ScchartPackage.FINAL_STATE___CAN_NEW_IMMEDIATE_TRANSITION__SCCHARTREFERECE;
				case ScchartPackage.SIMPLE_STATE___NEW_IMMEDIATE_TRANSITION__SCCHARTREFERECE: return ScchartPackage.FINAL_STATE___NEW_IMMEDIATE_TRANSITION__SCCHARTREFERECE;
				case ScchartPackage.SIMPLE_STATE___NEW_IMMEDIATE_TRANSITION__SCCHARTREFERECE_STRING: return ScchartPackage.FINAL_STATE___NEW_IMMEDIATE_TRANSITION__SCCHARTREFERECE_STRING;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ScchartPackage.FINAL_STATE___CAN_NEW_IMMEDIATE_TRANSITION__INITIALSCCHARTREFERECE:
				return canNewImmediateTransition((InitialSCChartReferece)arguments.get(0));
			case ScchartPackage.FINAL_STATE___NEW_IMMEDIATE_TRANSITION__INITIALSCCHARTREFERECE:
				return newImmediateTransition((InitialSCChartReferece)arguments.get(0));
			case ScchartPackage.FINAL_STATE___NEW_IMMEDIATE_TRANSITION__INITIALSCCHARTREFERECE_STRING:
			...
			case ScchartPackage.FINAL_STATE___CAN_NEW_IMMEDIATE_TRANSITION__FINALSCCHARTREFERECE:
				return canNewImmediateTransition((FinalSCChartReferece)arguments.get(0));
			case ScchartPackage.FINAL_STATE___NEW_IMMEDIATE_TRANSITION__FINALSCCHARTREFERECE:
				return newImmediateTransition((FinalSCChartReferece)arguments.get(0));
			case ScchartPackage.FINAL_STATE___NEW_IMMEDIATE_TRANSITION__FINALSCCHARTREFERECE_STRING:
				return newImmediateTransition((FinalSCChartReferece)arguments.get(0), (String)arguments.get(1));
			case ScchartPackage.FINAL_STATE___CAN_NEW_IMMEDIATE_TRANSITION__SCCHARTREFERECE:
				return canNewImmediateTransition((SCChartReferece)arguments.get(0));
			case ScchartPackage.FINAL_STATE___NEW_IMMEDIATE_TRANSITION__SCCHARTREFERECE:
				return newImmediateTransition((SCChartReferece)arguments.get(0));
			case ScchartPackage.FINAL_STATE___NEW_IMMEDIATE_TRANSITION__SCCHARTREFERECE_STRING:
