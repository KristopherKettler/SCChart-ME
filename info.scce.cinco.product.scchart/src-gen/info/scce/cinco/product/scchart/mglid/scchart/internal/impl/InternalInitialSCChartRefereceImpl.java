...
public class InternalInitialSCChartRefereceImpl extends InternalSCChartRefereceImpl implements InternalInitialSCChartReferece {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == InternalSCChartReferece.class) {
			switch (baseOperationID) {
				...
				case InternalPackage.INTERNAL_SC_CHART_REFERECE___GET_INITILAL_SUPER_STATE_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_SC_CHART_REFERECE___GET_INITILAL_SUPER_STATE_PREDECESSORS;
				...
				case InternalPackage.INTERNAL_SC_CHART_REFERECE___GET_INITILAL_SUPER_STATE_SUCCESSORS: return InternalPackage.INTERNAL_INITIAL_SC_CHART_REFERECE___GET_INITILAL_SUPER_STATE_SUCCESSORS;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case InternalPackage.INTERNAL_INITIAL_SC_CHART_REFERECE___GET_INITILAL_SUPER_STATE_PREDECESSORS:
			...
			case InternalPackage.INTERNAL_INITIAL_SC_CHART_REFERECE___GET_INITILAL_SUPER_STATE_SUCCESSORS:
