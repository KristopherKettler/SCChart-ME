...
import info.scce.cinco.product.scchart.mglid.scchart.views.OperatorView;
...
public class OperatorImpl extends NodeImpl implements Operator {
	...
	public InternalOperator getInternalOperator() {
		return (info.scce.cinco.product.scchart.mglid.scchart.internal.InternalOperator) getInternalElement();
	}
	...
	public boolean canMoveTo(final DataFlowRegion dataFlowRegion, final int x, final int y) {
		return dataFlowRegion.canContain(info.scce.cinco.product.scchart.mglid.scchart.Operator.class);
	}
	...
	public OperatorView getOperatorView() {
		OperatorView operatorView = info.scce.cinco.product.scchart.mglid.scchart.views.ViewsFactory.eINSTANCE.createOperatorView();
		operatorView.setInternalOperator((info.scce.cinco.product.scchart.mglid.scchart.internal.InternalOperator)getInternalElement());
		return operatorView;
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == ModelElement.class) {
			switch (baseOperationID) {
				case GraphmodelPackage.MODEL_ELEMENT___GET_CONTAINER: return ScchartPackage.OPERATOR___GET_CONTAINER;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ScchartPackage.OPERATOR___GET_CONNECTION_CIRCUIT_PREDECESSORS:
			...
			case ScchartPackage.OPERATOR___GET_CONNECTION_CIRCUIT_SUCCESSORS:
			...
			case ScchartPackage.OPERATOR___CAN_NEW_CONNECTION__CONNECTIONCIRCUIT:
				return canNewConnection((ConnectionCircuit)arguments.get(0));
			case ScchartPackage.OPERATOR___NEW_CONNECTION__CONNECTIONCIRCUIT:
				return newConnection((ConnectionCircuit)arguments.get(0));
			case ScchartPackage.OPERATOR___NEW_CONNECTION__CONNECTIONCIRCUIT_STRING:
			...
			case ScchartPackage.OPERATOR___SMOVE_TO__DATAFLOWREGION_INT_INT:
				...
				return null;
			case ScchartPackage.OPERATOR___GET_CONTAINER:
				return getContainer();
