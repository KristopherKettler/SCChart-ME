 ...
 * </p>
 * <ul>
 *   <li>{@link info.scce.cinco.product.scchart.scchart.internal.impl.InternalImmediateStrongAbortHistoryTransitionImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link info.scce.cinco.product.scchart.scchart.internal.impl.InternalImmediateStrongAbortHistoryTransitionImpl#getCount_delay <em>Count delay</em>}</li>
 *   <li>{@link info.scce.cinco.product.scchart.scchart.internal.impl.InternalImmediateStrongAbortHistoryTransitionImpl#isDeepHistory <em>Deep History</em>}</li>
 *   <li>{@link info.scce.cinco.product.scchart.scchart.internal.impl.InternalImmediateStrongAbortHistoryTransitionImpl#getEffect <em>Effect</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InternalImmediateStrongAbortHistoryTransitionImpl extends InternalAbstractTransitionImpl implements InternalImmediateStrongAbortHistoryTransition {
	 ...
	 * @generated
	 */
	protected InternalImmediateStrongAbortHistoryTransitionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return InternalPackage.Literals.INTERNAL_IMMEDIATE_STRONG_ABORT_HISTORY_TRANSITION;
	}
	...
	public void setCondition(String newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_IMMEDIATE_STRONG_ABORT_HISTORY_TRANSITION__CONDITION, oldCondition, condition));
	}
	...
	public void setCount_delay(String newCount_delay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_IMMEDIATE_STRONG_ABORT_HISTORY_TRANSITION__COUNT_DELAY, oldCount_delay, count_delay));
	}
	...
	public void setDeepHistory(boolean newDeepHistory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_IMMEDIATE_STRONG_ABORT_HISTORY_TRANSITION__DEEP_HISTORY, oldDeepHistory, deepHistory));
	}
	...
	public void setEffect(String newEffect) {
		...
		effect = newEffect;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_IMMEDIATE_STRONG_ABORT_HISTORY_TRANSITION__EFFECT, oldEffect, effect));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InternalPackage.INTERNAL_IMMEDIATE_STRONG_ABORT_HISTORY_TRANSITION__CONDITION:
				return getCondition();
			case InternalPackage.INTERNAL_IMMEDIATE_STRONG_ABORT_HISTORY_TRANSITION__COUNT_DELAY:
				return getCount_delay();
			case InternalPackage.INTERNAL_IMMEDIATE_STRONG_ABORT_HISTORY_TRANSITION__DEEP_HISTORY:
				return isDeepHistory();
			case InternalPackage.INTERNAL_IMMEDIATE_STRONG_ABORT_HISTORY_TRANSITION__EFFECT:
				return getEffect();
		}
...
} //InternalImmediateStrongAbortHistoryTransitionImpl
