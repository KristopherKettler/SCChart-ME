...
public class ImmediateStrongAbortDeferredTransitionImpl extends AbstractTransitionImpl implements ImmediateStrongAbortDeferredTransition {
	...
	public InternalImmediateStrongAbortDeferredTransition getInternalImmediateStrongAbortDeferredTransition() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalImmediateStrongAbortDeferredTransition) getInternalElement();
	}
	...
	public ImmediateStrongAbortDeferredTransitionView getImmediateStrongAbortDeferredTransitionView() {
		ImmediateStrongAbortDeferredTransitionView immediateStrongAbortDeferredTransitionView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createImmediateStrongAbortDeferredTransitionView();
		immediateStrongAbortDeferredTransitionView.setInternalImmediateStrongAbortDeferredTransition((info.scce.cinco.product.scchart.scchart.internal.InternalImmediateStrongAbortDeferredTransition)getInternalElement());
