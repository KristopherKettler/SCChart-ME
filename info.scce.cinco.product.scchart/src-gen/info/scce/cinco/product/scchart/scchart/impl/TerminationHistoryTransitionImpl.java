...
public class TerminationHistoryTransitionImpl extends AbstractTransitionImpl implements TerminationHistoryTransition {
	...
	public InternalTerminationHistoryTransition getInternalTerminationHistoryTransition() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalTerminationHistoryTransition) getInternalElement();
	}
	...
	public TerminationHistoryTransitionView getTerminationHistoryTransitionView() {
		TerminationHistoryTransitionView terminationHistoryTransitionView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createTerminationHistoryTransitionView();
		terminationHistoryTransitionView.setInternalTerminationHistoryTransition((info.scce.cinco.product.scchart.scchart.internal.InternalTerminationHistoryTransition)getInternalElement());
