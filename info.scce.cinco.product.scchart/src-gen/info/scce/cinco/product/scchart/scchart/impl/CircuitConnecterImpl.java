...
public class CircuitConnecterImpl extends NodeImpl implements CircuitConnecter {
	...
	public InternalCircuitConnecter getInternalCircuitConnecter() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalCircuitConnecter) getInternalElement();
	}
	...
	public boolean canMoveTo(final DataFlowRegion dataFlowRegion, final int x, final int y) {
		return dataFlowRegion.canContain(info.scce.cinco.product.scchart.scchart.CircuitConnecter.class);
	}
	...
	public boolean canMoveTo(final SCChartReferece sCChartReferece, final int x, final int y) {
		return sCChartReferece.canContain(info.scce.cinco.product.scchart.scchart.CircuitConnecter.class);
	}
	...
	public boolean canMoveTo(final InitialSCChartReferece initialSCChartReferece, final int x, final int y) {
		return initialSCChartReferece.canContain(info.scce.cinco.product.scchart.scchart.CircuitConnecter.class);
	}
	...
	public boolean canMoveTo(final FinalSCChartReferece finalSCChartReferece, final int x, final int y) {
		return finalSCChartReferece.canContain(info.scce.cinco.product.scchart.scchart.CircuitConnecter.class);
	}
	...
	public CircuitConnecterView getCircuitConnecterView() {
		CircuitConnecterView circuitConnecterView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createCircuitConnecterView();
		circuitConnecterView.setInternalCircuitConnecter((info.scce.cinco.product.scchart.scchart.internal.InternalCircuitConnecter)getInternalElement());
