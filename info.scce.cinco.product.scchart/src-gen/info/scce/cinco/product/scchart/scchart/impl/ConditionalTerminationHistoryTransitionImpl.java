...
public class ConditionalTerminationHistoryTransitionImpl extends AbstractTransitionImpl implements ConditionalTerminationHistoryTransition {
	...
	public InternalConditionalTerminationHistoryTransition getInternalConditionalTerminationHistoryTransition() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalConditionalTerminationHistoryTransition) getInternalElement();
	}
	...
	public ConditionalTerminationHistoryTransitionView getConditionalTerminationHistoryTransitionView() {
		ConditionalTerminationHistoryTransitionView conditionalTerminationHistoryTransitionView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createConditionalTerminationHistoryTransitionView();
		conditionalTerminationHistoryTransitionView.setInternalConditionalTerminationHistoryTransition((info.scce.cinco.product.scchart.scchart.internal.InternalConditionalTerminationHistoryTransition)getInternalElement());
