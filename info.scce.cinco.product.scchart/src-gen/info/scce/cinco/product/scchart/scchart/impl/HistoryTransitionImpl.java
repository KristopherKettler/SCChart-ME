...
public class HistoryTransitionImpl extends AbstractTransitionImpl implements HistoryTransition {
	...
	public InternalHistoryTransition getInternalHistoryTransition() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalHistoryTransition) getInternalElement();
	}
	...
	public HistoryTransitionView getHistoryTransitionView() {
		HistoryTransitionView historyTransitionView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createHistoryTransitionView();
		historyTransitionView.setInternalHistoryTransition((info.scce.cinco.product.scchart.scchart.internal.InternalHistoryTransition)getInternalElement());
