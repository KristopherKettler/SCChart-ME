...
public class ImmediateTransitionImpl extends AbstractTransitionImpl implements ImmediateTransition {
	...
	public InternalImmediateTransition getInternalImmediateTransition() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalImmediateTransition) getInternalElement();
	}
	...
	public ImmediateTransitionView getImmediateTransitionView() {
		ImmediateTransitionView immediateTransitionView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createImmediateTransitionView();
		immediateTransitionView.setInternalImmediateTransition((info.scce.cinco.product.scchart.scchart.internal.InternalImmediateTransition)getInternalElement());
