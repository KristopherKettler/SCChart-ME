...
public class ImmediateStrongAbortTransitionImpl extends AbstractTransitionImpl implements ImmediateStrongAbortTransition {
	...
	public InternalImmediateStrongAbortTransition getInternalImmediateStrongAbortTransition() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalImmediateStrongAbortTransition) getInternalElement();
	}
	...
	public ImmediateStrongAbortTransitionView getImmediateStrongAbortTransitionView() {
		ImmediateStrongAbortTransitionView immediateStrongAbortTransitionView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createImmediateStrongAbortTransitionView();
		immediateStrongAbortTransitionView.setInternalImmediateStrongAbortTransition((info.scce.cinco.product.scchart.scchart.internal.InternalImmediateStrongAbortTransition)getInternalElement());
