...
import info.scce.cinco.product.scchart.scchart.views.DeferredTransitionView;
...
public class DeferredTransitionImpl extends AbstractTransitionImpl implements DeferredTransition {
	...
	public InternalDeferredTransition getInternalDeferredTransition() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalDeferredTransition) getInternalElement();
	}
	...
	public DeferredTransitionView getDeferredTransitionView() {
		DeferredTransitionView deferredTransitionView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createDeferredTransitionView();
		deferredTransitionView.setInternalDeferredTransition((info.scce.cinco.product.scchart.scchart.internal.InternalDeferredTransition)getInternalElement());
