...
import info.scce.cinco.product.scchart.scchart.views.ConnectorView;
...
public class ConnectorImpl extends NodeImpl implements Connector {
	...
	public InternalConnector getInternalConnector() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalConnector) getInternalElement();
	}
	...
	public boolean canMoveTo(final Region region, final int x, final int y) {
		return region.canContain(info.scce.cinco.product.scchart.scchart.Connector.class);
	}
	...
	public boolean canMoveTo(final DataFlowRegion dataFlowRegion, final int x, final int y) {
		return dataFlowRegion.canContain(info.scce.cinco.product.scchart.scchart.Connector.class);
	}
	...
	public boolean canMoveTo(final SCChartReferece sCChartReferece, final int x, final int y) {
		return sCChartReferece.canContain(info.scce.cinco.product.scchart.scchart.Connector.class);
	}
	...
	public boolean canMoveTo(final InitialSCChartReferece initialSCChartReferece, final int x, final int y) {
		return initialSCChartReferece.canContain(info.scce.cinco.product.scchart.scchart.Connector.class);
	}
	...
	public boolean canMoveTo(final FinalSCChartReferece finalSCChartReferece, final int x, final int y) {
		return finalSCChartReferece.canContain(info.scce.cinco.product.scchart.scchart.Connector.class);
	}
	...
	public ConnectorView getConnectorView() {
		ConnectorView connectorView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createConnectorView();
		connectorView.setInternalConnector((info.scce.cinco.product.scchart.scchart.internal.InternalConnector)getInternalElement());
