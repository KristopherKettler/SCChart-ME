...
import info.scce.cinco.product.scchart.scchart.internal.InternalInitialState;

import info.scce.cinco.product.scchart.scchart.views.InitialStateView;
...
public class InitialStateImpl extends SimpleStateImpl implements InitialState {
	...
	public InternalInitialState getInternalInitialState() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalInitialState) getInternalElement();
	}
	...
	public boolean canMoveTo(final Region region, final int x, final int y) {
		return region.canContain(info.scce.cinco.product.scchart.scchart.InitialState.class);
	}
	...
	public boolean canMoveTo(final DataFlowRegion dataFlowRegion, final int x, final int y) {
		return dataFlowRegion.canContain(info.scce.cinco.product.scchart.scchart.InitialState.class);
	}
	...
	public boolean canMoveTo(final SCChartReferece sCChartReferece, final int x, final int y) {
		return sCChartReferece.canContain(info.scce.cinco.product.scchart.scchart.InitialState.class);
	}
	...
	public boolean canMoveTo(final InitialSCChartReferece initialSCChartReferece, final int x, final int y) {
		return initialSCChartReferece.canContain(info.scce.cinco.product.scchart.scchart.InitialState.class);
	}
	...
	public boolean canMoveTo(final FinalSCChartReferece finalSCChartReferece, final int x, final int y) {
		return finalSCChartReferece.canContain(info.scce.cinco.product.scchart.scchart.InitialState.class);
	}
	...
	public InitialStateView getInitialStateView() {
		InitialStateView initialStateView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createInitialStateView();
		initialStateView.setInternalInitialState((info.scce.cinco.product.scchart.scchart.internal.InternalInitialState)getInternalElement());
