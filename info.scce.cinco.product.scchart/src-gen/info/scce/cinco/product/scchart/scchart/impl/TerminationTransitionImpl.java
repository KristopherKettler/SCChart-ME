...
public class TerminationTransitionImpl extends AbstractTransitionImpl implements TerminationTransition {
	...
	public InternalTerminationTransition getInternalTerminationTransition() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalTerminationTransition) getInternalElement();
	}
	...
	public TerminationTransitionView getTerminationTransitionView() {
		TerminationTransitionView terminationTransitionView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createTerminationTransitionView();
		terminationTransitionView.setInternalTerminationTransition((info.scce.cinco.product.scchart.scchart.internal.InternalTerminationTransition)getInternalElement());
