...
public class ImmediateHistoryTransitionImpl extends AbstractTransitionImpl implements ImmediateHistoryTransition {
	...
	public InternalImmediateHistoryTransition getInternalImmediateHistoryTransition() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalImmediateHistoryTransition) getInternalElement();
	}
	...
	public ImmediateHistoryTransitionView getImmediateHistoryTransitionView() {
		ImmediateHistoryTransitionView immediateHistoryTransitionView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createImmediateHistoryTransitionView();
		immediateHistoryTransitionView.setInternalImmediateHistoryTransition((info.scce.cinco.product.scchart.scchart.internal.InternalImmediateHistoryTransition)getInternalElement());
