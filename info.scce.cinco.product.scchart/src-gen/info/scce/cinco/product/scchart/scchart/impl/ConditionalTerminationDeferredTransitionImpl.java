...
public class ConditionalTerminationDeferredTransitionImpl extends AbstractTransitionImpl implements ConditionalTerminationDeferredTransition {
	...
	public InternalConditionalTerminationDeferredTransition getInternalConditionalTerminationDeferredTransition() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalConditionalTerminationDeferredTransition) getInternalElement();
	}
	...
	public ConditionalTerminationDeferredTransitionView getConditionalTerminationDeferredTransitionView() {
		ConditionalTerminationDeferredTransitionView conditionalTerminationDeferredTransitionView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createConditionalTerminationDeferredTransitionView();
		conditionalTerminationDeferredTransitionView.setInternalConditionalTerminationDeferredTransition((info.scce.cinco.product.scchart.scchart.internal.InternalConditionalTerminationDeferredTransition)getInternalElement());
