...
public class SimpleStateImpl extends NodeImpl implements SimpleState {
	...
	public InternalSimpleState getInternalSimpleState() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalSimpleState) getInternalElement();
	}
	...
	public boolean canMoveTo(final Region region, final int x, final int y) {
		return region.canContain(info.scce.cinco.product.scchart.scchart.SimpleState.class);
	}
	...
	public boolean canMoveTo(final DataFlowRegion dataFlowRegion, final int x, final int y) {
		return dataFlowRegion.canContain(info.scce.cinco.product.scchart.scchart.SimpleState.class);
	}
	...
	public boolean canMoveTo(final SCChartReferece sCChartReferece, final int x, final int y) {
		return sCChartReferece.canContain(info.scce.cinco.product.scchart.scchart.SimpleState.class);
	}
	...
	public boolean canMoveTo(final InitialSCChartReferece initialSCChartReferece, final int x, final int y) {
		return initialSCChartReferece.canContain(info.scce.cinco.product.scchart.scchart.SimpleState.class);
	}
	...
	public boolean canMoveTo(final FinalSCChartReferece finalSCChartReferece, final int x, final int y) {
		return finalSCChartReferece.canContain(info.scce.cinco.product.scchart.scchart.SimpleState.class);
	}
	...
	public SimpleStateView getSimpleStateView() {
		SimpleStateView simpleStateView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createSimpleStateView();
		simpleStateView.setInternalSimpleState((info.scce.cinco.product.scchart.scchart.internal.InternalSimpleState)getInternalElement());
