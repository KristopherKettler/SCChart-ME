...
public class TransitionImpl extends AbstractTransitionImpl implements Transition {
	...
	public InternalTransition getInternalTransition() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalTransition) getInternalElement();
	}
	...
	public TransitionView getTransitionView() {
		TransitionView transitionView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createTransitionView();
		transitionView.setInternalTransition((info.scce.cinco.product.scchart.scchart.internal.InternalTransition)getInternalElement());
