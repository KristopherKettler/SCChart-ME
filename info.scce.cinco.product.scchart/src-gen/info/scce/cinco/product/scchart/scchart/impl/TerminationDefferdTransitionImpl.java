...
public class TerminationDefferdTransitionImpl extends AbstractTransitionImpl implements TerminationDefferdTransition {
	...
	public InternalTerminationDefferdTransition getInternalTerminationDefferdTransition() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalTerminationDefferdTransition) getInternalElement();
	}
	...
	public TerminationDefferdTransitionView getTerminationDefferdTransitionView() {
		TerminationDefferdTransitionView terminationDefferdTransitionView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createTerminationDefferdTransitionView();
		terminationDefferdTransitionView.setInternalTerminationDefferdTransition((info.scce.cinco.product.scchart.scchart.internal.InternalTerminationDefferdTransition)getInternalElement());
