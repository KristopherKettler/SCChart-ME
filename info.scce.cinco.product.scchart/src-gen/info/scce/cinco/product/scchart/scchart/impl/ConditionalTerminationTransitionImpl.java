...
public class ConditionalTerminationTransitionImpl extends AbstractTransitionImpl implements ConditionalTerminationTransition {
	...
	public InternalConditionalTerminationTransition getInternalConditionalTerminationTransition() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalConditionalTerminationTransition) getInternalElement();
	}
	...
	public ConditionalTerminationTransitionView getConditionalTerminationTransitionView() {
		ConditionalTerminationTransitionView conditionalTerminationTransitionView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createConditionalTerminationTransitionView();
		conditionalTerminationTransitionView.setInternalConditionalTerminationTransition((info.scce.cinco.product.scchart.scchart.internal.InternalConditionalTerminationTransition)getInternalElement());
