...
public class StrongAbortDeferredTransitionImpl extends AbstractTransitionImpl implements StrongAbortDeferredTransition {
	...
	public InternalStrongAbortDeferredTransition getInternalStrongAbortDeferredTransition() {
		return (info.scce.cinco.product.scchart.scchart.internal.InternalStrongAbortDeferredTransition) getInternalElement();
	}
	...
	public StrongAbortDeferredTransitionView getStrongAbortDeferredTransitionView() {
		StrongAbortDeferredTransitionView strongAbortDeferredTransitionView = info.scce.cinco.product.scchart.scchart.views.ViewsFactory.eINSTANCE.createStrongAbortDeferredTransitionView();
		strongAbortDeferredTransitionView.setInternalStrongAbortDeferredTransition((info.scce.cinco.product.scchart.scchart.internal.InternalStrongAbortDeferredTransition)getInternalElement());
