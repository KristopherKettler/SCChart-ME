...
public class FinalSCChartRefereceEContentAdapter extends EContentAdapter implements CincoEContentAdapter {
  @Override
  public void notifyChanged(final Notification notification) {
    super.notifyChanged(notification);
    final Object o = notification.getNotifier();
    final Object feature = notification.getFeature();
    if ((o instanceof InternalFinalSCChartReferece)) {
      if ((Objects.equal(((InternalFinalSCChartReferece)o).eContainer(), null) && (!(o instanceof InternalGraphModel)))) {
        return;
      }
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          _matched=true;
          ModelElement _element = ((InternalFinalSCChartReferece)o).getElement();
          String _name = ((EStructuralFeature)feature).getName();
          Object _oldValue = notification.getOldValue();
          final PostAttributeChangePayload<FinalSCChartReferece> eventPayload = new PostAttributeChangePayload<FinalSCChartReferece>(((FinalSCChartReferece) _element), _name, _oldValue);
          final PayloadContext<PostAttributeChangePayload<FinalSCChartReferece>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<FinalSCChartReferece>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_mglid_scchart_FinalSCChartReferece", eventPayload);
          EventHub.getInstance().notifyFirst(eventContext);
          ModelElement _element_1 = ((InternalFinalSCChartReferece)o).getElement();
