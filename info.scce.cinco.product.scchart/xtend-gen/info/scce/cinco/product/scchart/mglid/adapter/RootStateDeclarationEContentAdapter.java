...
public class RootStateDeclarationEContentAdapter extends EContentAdapter {
  @Extension
  ...
  public void notifyChanged(final Notification notification) {
    ...
    if ((o instanceof InternalRootStateDeclaration)) {
      EObject _eContainer = ((InternalRootStateDeclaration)o).eContainer();
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          _matched=true;
          Type _element = ((InternalRootStateDeclaration)o).getElement();
