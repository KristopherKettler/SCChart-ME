...
public class MoveFeatureSuspendNode extends CincoMoveShapeFeature {
   ...
   */
  public MoveFeatureSuspendNode(final IFeatureProvider fp) {
    super(fp);
  }
  ...
  public boolean canMoveShape(final IMoveShapeContext context, final boolean apiCall) {
    if (apiCall) {
      ...
      if ((target instanceof InternalModelElementContainer)) {
        return ((InternalModelElementContainer) target).canContain(SuspendNode.class);
      }
  ...
  public void moveShape(final IMoveShapeContext context) {
    throw new Error("Unresolved compilation problems:"
      + "\ninfo.scce.cinco.product.scchart.mglid.editor.graphiti.api.CSuspendNode cannot be resolved to a type.");
  }
  
  protected boolean _moveContainer(final InternalModelElementContainer target, final SuspendNode oe, final IMoveShapeContext context) {
    return false;
  }
  
  protected boolean _moveContainer(final InternalRootState target, final SuspendNode oe, final IMoveShapeContext context) {
  ...
  protected boolean _moveContainer(final InternalSuperState target, final SuspendNode oe, final IMoveShapeContext context) {
    ModelElementContainer _containerElement = target.getContainerElement();
    oe.moveTo(((SuperState) _containerElement), context.getX(), context.getY());
    return true;
  }
  
  protected boolean _moveContainer(final InternalInitilalSuperState target, final SuspendNode oe, final IMoveShapeContext context) {
    ModelElementContainer _containerElement = target.getContainerElement();
  ...
  public boolean moveContainer(final InternalModelElementContainer target, final SuspendNode oe, final IMoveShapeContext context) {
