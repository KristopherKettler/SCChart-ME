...
public class RegionEContentAdapter extends EContentAdapter implements CincoEContentAdapter {
  @Override
  public void notifyChanged(final Notification notification) {
    super.notifyChanged(notification);
    final Object o = notification.getNotifier();
    final Object feature = notification.getFeature();
    if ((o instanceof InternalRegion)) {
      if ((Objects.equal(((InternalRegion)o).eContainer(), null) && (!(o instanceof InternalGraphModel)))) {
        return;
      }
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          _matched=true;
          ModelElement _element = ((InternalRegion)o).getElement();
          String _name = ((EStructuralFeature)feature).getName();
          Object _oldValue = notification.getOldValue();
          final PostAttributeChangePayload<Region> eventPayload = new PostAttributeChangePayload<Region>(((Region) _element), _name, _oldValue);
          final PayloadContext<PostAttributeChangePayload<Region>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<Region>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_mglid_scchart_Region", eventPayload);
          EventHub.getInstance().notifyFirst(eventContext);
          ModelElement _element_1 = ((InternalRegion)o).getElement();
