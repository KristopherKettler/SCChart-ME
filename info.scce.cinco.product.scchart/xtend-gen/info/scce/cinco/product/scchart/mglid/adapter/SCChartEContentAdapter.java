    ...
    if ((o instanceof InternalSCChart)) {
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          ...
          final PayloadContext<PostAttributeChangePayload<SCChart>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<SCChart>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_mglid_scchart_SCChart", eventPayload);
