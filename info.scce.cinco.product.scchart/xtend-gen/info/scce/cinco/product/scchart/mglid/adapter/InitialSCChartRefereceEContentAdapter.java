...
public class InitialSCChartRefereceEContentAdapter extends EContentAdapter implements CincoEContentAdapter {
  @Override
  public void notifyChanged(final Notification notification) {
    super.notifyChanged(notification);
    final Object o = notification.getNotifier();
    final Object feature = notification.getFeature();
    if ((o instanceof InternalInitialSCChartReferece)) {
      if ((Objects.equal(((InternalInitialSCChartReferece)o).eContainer(), null) && (!(o instanceof InternalGraphModel)))) {
        return;
      }
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          _matched=true;
          ModelElement _element = ((InternalInitialSCChartReferece)o).getElement();
          String _name = ((EStructuralFeature)feature).getName();
          Object _oldValue = notification.getOldValue();
          final PostAttributeChangePayload<InitialSCChartReferece> eventPayload = new PostAttributeChangePayload<InitialSCChartReferece>(((InitialSCChartReferece) _element), _name, _oldValue);
          final PayloadContext<PostAttributeChangePayload<InitialSCChartReferece>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<InitialSCChartReferece>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_mglid_scchart_InitialSCChartReferece", eventPayload);
          EventHub.getInstance().notifyFirst(eventContext);
          ModelElement _element_1 = ((InternalInitialSCChartReferece)o).getElement();
