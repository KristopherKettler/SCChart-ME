...
public class MoveFeatureDataFlowRegion extends CincoMoveShapeFeature {
   ...
   */
  public MoveFeatureDataFlowRegion(final IFeatureProvider fp) {
    super(fp);
  }
  ...
  public boolean canMoveShape(final IMoveShapeContext context, final boolean apiCall) {
    if (apiCall) {
      ...
      if ((target instanceof InternalModelElementContainer)) {
        return ((InternalModelElementContainer) target).canContain(DataFlowRegion.class);
      }
  ...
  public void moveShape(final IMoveShapeContext context) {
    throw new Error("Unresolved compilation problems:"
      + "\ninfo.scce.cinco.product.scchart.mglid.editor.graphiti.api.CDataFlowRegion cannot be resolved to a type.");
  }
  
  protected boolean _moveContainer(final InternalModelElementContainer target, final DataFlowRegion oe, final IMoveShapeContext context) {
    return false;
  }
  
  protected boolean _moveContainer(final InternalRootState target, final DataFlowRegion oe, final IMoveShapeContext context) {
    ModelElementContainer _containerElement = target.getContainerElement();
    oe.moveTo(((RootState) _containerElement), context.getX(), context.getY());
    return true;
  }
  
  protected boolean _moveContainer(final InternalSuperState target, final DataFlowRegion oe, final IMoveShapeContext context) {
    ModelElementContainer _containerElement = target.getContainerElement();
    oe.moveTo(((SuperState) _containerElement), context.getX(), context.getY());
    return true;
  }
  
  protected boolean _moveContainer(final InternalInitilalSuperState target, final DataFlowRegion oe, final IMoveShapeContext context) {
    ModelElementContainer _containerElement = target.getContainerElement();
    oe.moveTo(((InitilalSuperState) _containerElement), context.getX(), context.getY());
    return true;
  }
  ...
  public boolean moveContainer(final InternalModelElementContainer target, final DataFlowRegion oe, final IMoveShapeContext context) {
    if (target instanceof InternalInitilalSuperState) {
      return _moveContainer((InternalInitilalSuperState)target, oe, context);
    } else if (target instanceof InternalRootState) {
      return _moveContainer((InternalRootState)target, oe, context);
    } else if (target instanceof InternalSuperState) {
      return _moveContainer((InternalSuperState)target, oe, context);
    } else if (target != null) {
