    ...
    if ((o instanceof InternalInitilalSuperState)) {
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          ...
          final PayloadContext<PostAttributeChangePayload<InitilalSuperState>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<InitilalSuperState>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_mglid_scchart_InitilalSuperState", eventPayload);
