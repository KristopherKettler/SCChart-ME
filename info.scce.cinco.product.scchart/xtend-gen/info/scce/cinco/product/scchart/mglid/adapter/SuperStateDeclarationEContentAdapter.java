...
public class SuperStateDeclarationEContentAdapter extends EContentAdapter {
  @Extension
  ...
  public void notifyChanged(final Notification notification) {
    ...
    if ((o instanceof InternalSuperStateDeclaration)) {
      EObject _eContainer = ((InternalSuperStateDeclaration)o).eContainer();
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          _matched=true;
          Type _element = ((InternalSuperStateDeclaration)o).getElement();
