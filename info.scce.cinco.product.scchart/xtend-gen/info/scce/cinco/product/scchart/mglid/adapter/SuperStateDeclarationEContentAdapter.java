...
public class SuperStateDeclarationEContentAdapter extends EContentAdapter implements CincoEContentAdapter {
  @Override
  public void notifyChanged(final Notification notification) {
    super.notifyChanged(notification);
    final Object o = notification.getNotifier();
    final Object feature = notification.getFeature();
    if ((o instanceof InternalSuperStateDeclaration)) {
      if ((Objects.equal(((InternalSuperStateDeclaration)o).eContainer(), null) && (!(o instanceof InternalGraphModel)))) {
        return;
      }
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          _matched=true;
          ModelElement _element = ((InternalSuperStateDeclaration)o).getElement();
          String _name = ((EStructuralFeature)feature).getName();
          Object _oldValue = notification.getOldValue();
          final PostAttributeChangePayload<SuperStateDeclaration> eventPayload = new PostAttributeChangePayload<SuperStateDeclaration>(((SuperStateDeclaration) _element), _name, _oldValue);
          final PayloadContext<PostAttributeChangePayload<SuperStateDeclaration>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<SuperStateDeclaration>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_mglid_scchart_SuperStateDeclaration", eventPayload);
          EventHub.getInstance().notifyFirst(eventContext);
          ModelElement _element_1 = ((InternalSuperStateDeclaration)o).getElement();
