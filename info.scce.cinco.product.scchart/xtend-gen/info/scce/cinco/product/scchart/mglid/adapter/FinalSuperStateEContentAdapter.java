...
public class FinalSuperStateEContentAdapter extends EContentAdapter implements CincoEContentAdapter {
  @Override
  public void notifyChanged(final Notification notification) {
    super.notifyChanged(notification);
    final Object o = notification.getNotifier();
    final Object feature = notification.getFeature();
    if ((o instanceof InternalFinalSuperState)) {
      if ((Objects.equal(((InternalFinalSuperState)o).eContainer(), null) && (!(o instanceof InternalGraphModel)))) {
        return;
      }
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          _matched=true;
          ModelElement _element = ((InternalFinalSuperState)o).getElement();
          String _name = ((EStructuralFeature)feature).getName();
          Object _oldValue = notification.getOldValue();
          final PostAttributeChangePayload<FinalSuperState> eventPayload = new PostAttributeChangePayload<FinalSuperState>(((FinalSuperState) _element), _name, _oldValue);
          final PayloadContext<PostAttributeChangePayload<FinalSuperState>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<FinalSuperState>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_mglid_scchart_FinalSuperState", eventPayload);
          EventHub.getInstance().notifyFirst(eventContext);
          ModelElement _element_1 = ((InternalFinalSuperState)o).getElement();
