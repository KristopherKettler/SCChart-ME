...
public class SubSuperStateDeclarationEContentAdapter extends EContentAdapter {
  @Extension
  ...
  public void notifyChanged(final Notification notification) {
    ...
    if ((o instanceof InternalSubSuperStateDeclaration)) {
      EObject _eContainer = ((InternalSubSuperStateDeclaration)o).eContainer();
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          _matched=true;
          Type _element = ((InternalSubSuperStateDeclaration)o).getElement();
