...
public class MoveFeatureRootStateDeclarationNode extends CincoMoveShapeFeature {
   ...
   */
  public MoveFeatureRootStateDeclarationNode(final IFeatureProvider fp) {
    super(fp);
  }
  ...
  public boolean canMoveShape(final IMoveShapeContext context, final boolean apiCall) {
    if (apiCall) {
      ...
      if ((target instanceof InternalModelElementContainer)) {
        return ((InternalModelElementContainer) target).canContain(RootStateDeclarationNode.class);
      }
  ...
  public void moveShape(final IMoveShapeContext context) {
    throw new Error("Unresolved compilation problems:"
      + "\ninfo.scce.cinco.product.scchart.mglid.editor.graphiti.api.CRootStateDeclarationNode cannot be resolved to a type.");
  }
  
  protected boolean _moveContainer(final InternalModelElementContainer target, final RootStateDeclarationNode oe, final IMoveShapeContext context) {
    return false;
  }
  
  protected boolean _moveContainer(final InternalRootState target, final RootStateDeclarationNode oe, final IMoveShapeContext context) {
  ...
  public boolean moveContainer(final InternalModelElementContainer target, final RootStateDeclarationNode oe, final IMoveShapeContext context) {
    if (target instanceof InternalRootState) {
