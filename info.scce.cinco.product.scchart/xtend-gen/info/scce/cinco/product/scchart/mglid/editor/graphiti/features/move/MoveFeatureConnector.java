...
public class MoveFeatureConnector extends CincoMoveShapeFeature {
   ...
   */
  public MoveFeatureConnector(final IFeatureProvider fp) {
    super(fp);
  }
  ...
  public boolean canMoveShape(final IMoveShapeContext context, final boolean apiCall) {
    if (apiCall) {
      ...
      if ((target instanceof InternalModelElementContainer)) {
        return ((InternalModelElementContainer) target).canContain(Connector.class);
      }
  ...
  public void moveShape(final IMoveShapeContext context) {
    throw new Error("Unresolved compilation problems:"
      + "\ninfo.scce.cinco.product.scchart.mglid.editor.graphiti.api.CConnector cannot be resolved to a type.");
  }
  
  protected boolean _moveContainer(final InternalModelElementContainer target, final Connector oe, final IMoveShapeContext context) {
    return false;
  }
  
  protected boolean _moveContainer(final InternalRegion target, final Connector oe, final IMoveShapeContext context) {
  ...
  protected boolean _moveContainer(final InternalDataFlowRegion target, final Connector oe, final IMoveShapeContext context) {
    ModelElementContainer _containerElement = target.getContainerElement();
  ...
  public boolean moveContainer(final InternalModelElementContainer target, final Connector oe, final IMoveShapeContext context) {
