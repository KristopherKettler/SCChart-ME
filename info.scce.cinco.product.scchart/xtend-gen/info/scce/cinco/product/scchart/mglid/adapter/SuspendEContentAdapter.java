...
public class SuspendEContentAdapter extends EContentAdapter implements CincoEContentAdapter {
  @Override
  public void notifyChanged(final Notification notification) {
    ...
    if ((o instanceof InternalSuspend)) {
      if ((Objects.equal(((InternalSuspend)o).eContainer(), null) && (!(o instanceof InternalGraphModel)))) {
        return;
      }
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          _matched=true;
          ModelElement _element = ((InternalSuspend)o).getElement();
          String _name = ((EStructuralFeature)feature).getName();
          Object _oldValue = notification.getOldValue();
          final PostAttributeChangePayload<Suspend> eventPayload = new PostAttributeChangePayload<Suspend>(((Suspend) _element), _name, _oldValue);
          final PayloadContext<PostAttributeChangePayload<Suspend>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<Suspend>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_mglid_scchart_Suspend", eventPayload);
          EventHub.getInstance().notifyFirst(eventContext);
          ModelElement _element_1 = ((InternalSuspend)o).getElement();
