    ...
    if ((o instanceof InternalAction)) {
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          ...
          final PostAttributeChangePayload<Action> eventPayload = new PostAttributeChangePayload<Action>(((Action) _element), _name, _oldValue);
          final PayloadContext<PostAttributeChangePayload<Action>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<Action>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_mglid_scchart_Action", eventPayload);
          EventHub.getInstance().notifyFirst(eventContext);
          ModelElement _element_1 = ((InternalAction)o).getElement();
