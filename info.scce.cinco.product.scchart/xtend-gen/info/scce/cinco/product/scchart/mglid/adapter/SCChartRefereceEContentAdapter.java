...
public class SCChartRefereceEContentAdapter extends EContentAdapter implements CincoEContentAdapter {
  @Override
  public void notifyChanged(final Notification notification) {
    super.notifyChanged(notification);
    final Object o = notification.getNotifier();
    final Object feature = notification.getFeature();
    if ((o instanceof InternalSCChartReferece)) {
      if ((Objects.equal(((InternalSCChartReferece)o).eContainer(), null) && (!(o instanceof InternalGraphModel)))) {
        return;
      }
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          _matched=true;
          ModelElement _element = ((InternalSCChartReferece)o).getElement();
          String _name = ((EStructuralFeature)feature).getName();
          Object _oldValue = notification.getOldValue();
          final PostAttributeChangePayload<SCChartReferece> eventPayload = new PostAttributeChangePayload<SCChartReferece>(((SCChartReferece) _element), _name, _oldValue);
          final PayloadContext<PostAttributeChangePayload<SCChartReferece>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<SCChartReferece>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_mglid_scchart_SCChartReferece", eventPayload);
          EventHub.getInstance().notifyFirst(eventContext);
          ModelElement _element_1 = ((InternalSCChartReferece)o).getElement();
