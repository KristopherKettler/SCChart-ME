    ...
    if ((o instanceof InternalDataFlowRegion)) {
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          ...
          final PayloadContext<PostAttributeChangePayload<DataFlowRegion>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<DataFlowRegion>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_mglid_scchart_DataFlowRegion", eventPayload);
