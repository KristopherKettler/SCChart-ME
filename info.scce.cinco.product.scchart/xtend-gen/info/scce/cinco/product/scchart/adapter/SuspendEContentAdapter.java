    ...
    if ((o instanceof InternalSuspend)) {
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          ...
          final PayloadContext<PostAttributeChangePayload<Suspend>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<Suspend>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_scchart_Suspend", eventPayload);
