    ...
    if ((o instanceof InternalAction)) {
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          ...
          final PayloadContext<PostAttributeChangePayload<Action>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<Action>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_scchart_Action", eventPayload);
