    ...
    if ((o instanceof InternalFinalSCChartReferece)) {
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          ...
          final PayloadContext<PostAttributeChangePayload<FinalSCChartReferece>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<FinalSCChartReferece>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_scchart_FinalSCChartReferece", eventPayload);
