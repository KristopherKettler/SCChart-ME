    ...
    if ((o instanceof InternalRegion)) {
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          ...
          final PayloadContext<PostAttributeChangePayload<Region>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<Region>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_scchart_Region", eventPayload);
