    ...
    if ((o instanceof InternalSCChartReferece)) {
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          ...
          final PayloadContext<PostAttributeChangePayload<SCChartReferece>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<SCChartReferece>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_scchart_SCChartReferece", eventPayload);
