    ...
    if ((o instanceof InternalRootState)) {
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          ...
          final PayloadContext<PostAttributeChangePayload<RootState>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<RootState>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_scchart_RootState", eventPayload);
