    ...
    if ((o instanceof InternalInitialSCChartReferece)) {
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          ...
          final PayloadContext<PostAttributeChangePayload<InitialSCChartReferece>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<InitialSCChartReferece>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_scchart_InitialSCChartReferece", eventPayload);
