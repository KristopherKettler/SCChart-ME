    ...
    if ((o instanceof InternalSuperState)) {
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          ...
          final PayloadContext<PostAttributeChangePayload<SuperState>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<SuperState>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_scchart_SuperState", eventPayload);
