    ...
    if ((o instanceof InternalDeclaration)) {
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          ...
          final PayloadContext<PostAttributeChangePayload<Declaration>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<Declaration>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_scchart_Declaration", eventPayload);
