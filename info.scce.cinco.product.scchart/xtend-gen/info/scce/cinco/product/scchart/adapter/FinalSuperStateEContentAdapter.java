    ...
    if ((o instanceof InternalFinalSuperState)) {
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          ...
          final PayloadContext<PostAttributeChangePayload<FinalSuperState>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<FinalSuperState>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_scchart_FinalSuperState", eventPayload);
