...
public class SuperStateDeclarationInputOutputProvider extends CincoValuesProvider<SuperStateDeclaration, String> {
  @Override
  public Map<String, String> getPossibleValues(final SuperStateDeclaration inputOutput) {
