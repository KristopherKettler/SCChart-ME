    ...
    for (final RootState rootState : _rootStates) {
      {
        ...
        if (((!((rootState.getName().charAt(0) >= 'a') && (rootState.getName().charAt(0) <= 'z'))) || ((rootState.getName().charAt(0) >= 'A') && (rootState.getName().charAt(0) <= 'Z')))) {
        ...
        while (((i < rootState.getName().length()) && (!break_))) {
          {
            boolean _not = (!((((rootState.getName().charAt(i) >= 'a') && (rootState.getName().charAt(i) <= 'z')) || ((rootState.getName().charAt(i) >= 'A') && (rootState.getName().charAt(i) <= 'Z'))) || Character.isDigit(rootState.getName().charAt(i))));
            if (_not) {
